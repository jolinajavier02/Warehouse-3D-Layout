(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))s(l);new MutationObserver(l=>{for(const c of l)if(c.type==="childList")for(const h of c.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&s(h)}).observe(document,{childList:!0,subtree:!0});function i(l){const c={};return l.integrity&&(c.integrity=l.integrity),l.referrerPolicy&&(c.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?c.credentials="include":l.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function s(l){if(l.ep)return;l.ep=!0;const c=i(l);fetch(l.href,c)}})();var xh={exports:{}},Vo={};var Hx;function tS(){if(Hx)return Vo;Hx=1;var r=Symbol.for("react.transitional.element"),t=Symbol.for("react.fragment");function i(s,l,c){var h=null;if(c!==void 0&&(h=""+c),l.key!==void 0&&(h=""+l.key),"key"in l){c={};for(var d in l)d!=="key"&&(c[d]=l[d])}else c=l;return l=c.ref,{$$typeof:r,type:s,key:h,ref:l!==void 0?l:null,props:c}}return Vo.Fragment=t,Vo.jsx=i,Vo.jsxs=i,Vo}var Gx;function eS(){return Gx||(Gx=1,xh.exports=tS()),xh.exports}var Kt=eS(),gh={exports:{}},oe={};var Vx;function nS(){if(Vx)return oe;Vx=1;var r=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),h=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),_=Symbol.for("react.lazy"),v=Symbol.for("react.activity"),y=Symbol.iterator;function M(O){return O===null||typeof O!="object"?null:(O=y&&O[y]||O["@@iterator"],typeof O=="function"?O:null)}var T={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},A=Object.assign,S={};function x(O,st,St){this.props=O,this.context=st,this.refs=S,this.updater=St||T}x.prototype.isReactComponent={},x.prototype.setState=function(O,st){if(typeof O!="object"&&typeof O!="function"&&O!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,O,st,"setState")},x.prototype.forceUpdate=function(O){this.updater.enqueueForceUpdate(this,O,"forceUpdate")};function L(){}L.prototype=x.prototype;function D(O,st,St){this.props=O,this.context=st,this.refs=S,this.updater=St||T}var F=D.prototype=new L;F.constructor=D,A(F,x.prototype),F.isPureReactComponent=!0;var k=Array.isArray;function N(){}var z={H:null,A:null,T:null,S:null},G=Object.prototype.hasOwnProperty;function w(O,st,St){var Et=St.ref;return{$$typeof:r,type:O,key:st,ref:Et!==void 0?Et:null,props:St}}function C(O,st){return w(O.type,st,O.props)}function V(O){return typeof O=="object"&&O!==null&&O.$$typeof===r}function et(O){var st={"=":"=0",":":"=2"};return"$"+O.replace(/[=:]/g,function(St){return st[St]})}var ot=/\/+/g;function dt(O,st){return typeof O=="object"&&O!==null&&O.key!=null?et(""+O.key):st.toString(36)}function ct(O){switch(O.status){case"fulfilled":return O.value;case"rejected":throw O.reason;default:switch(typeof O.status=="string"?O.then(N,N):(O.status="pending",O.then(function(st){O.status==="pending"&&(O.status="fulfilled",O.value=st)},function(st){O.status==="pending"&&(O.status="rejected",O.reason=st)})),O.status){case"fulfilled":return O.value;case"rejected":throw O.reason}}throw O}function P(O,st,St,Et,Ot){var it=typeof O;(it==="undefined"||it==="boolean")&&(O=null);var ut=!1;if(O===null)ut=!0;else switch(it){case"bigint":case"string":case"number":ut=!0;break;case"object":switch(O.$$typeof){case r:case t:ut=!0;break;case _:return ut=O._init,P(ut(O._payload),st,St,Et,Ot)}}if(ut)return Ot=Ot(O),ut=Et===""?"."+dt(O,0):Et,k(Ot)?(St="",ut!=null&&(St=ut.replace(ot,"$&/")+"/"),P(Ot,st,St,"",function(Xt){return Xt})):Ot!=null&&(V(Ot)&&(Ot=C(Ot,St+(Ot.key==null||O&&O.key===Ot.key?"":(""+Ot.key).replace(ot,"$&/")+"/")+ut)),st.push(Ot)),1;ut=0;var Ct=Et===""?".":Et+":";if(k(O))for(var It=0;It<O.length;It++)Et=O[It],it=Ct+dt(Et,It),ut+=P(Et,st,St,it,Ot);else if(It=M(O),typeof It=="function")for(O=It.call(O),It=0;!(Et=O.next()).done;)Et=Et.value,it=Ct+dt(Et,It++),ut+=P(Et,st,St,it,Ot);else if(it==="object"){if(typeof O.then=="function")return P(ct(O),st,St,Et,Ot);throw st=String(O),Error("Objects are not valid as a React child (found: "+(st==="[object Object]"?"object with keys {"+Object.keys(O).join(", ")+"}":st)+"). If you meant to render a collection of children, use an array instead.")}return ut}function W(O,st,St){if(O==null)return O;var Et=[],Ot=0;return P(O,Et,"","",function(it){return st.call(St,it,Ot++)}),Et}function Z(O){if(O._status===-1){var st=O._result;st=st(),st.then(function(St){(O._status===0||O._status===-1)&&(O._status=1,O._result=St)},function(St){(O._status===0||O._status===-1)&&(O._status=2,O._result=St)}),O._status===-1&&(O._status=0,O._result=st)}if(O._status===1)return O._result.default;throw O._result}var gt=typeof reportError=="function"?reportError:function(O){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var st=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof O=="object"&&O!==null&&typeof O.message=="string"?String(O.message):String(O),error:O});if(!window.dispatchEvent(st))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",O);return}console.error(O)},_t={map:W,forEach:function(O,st,St){W(O,function(){st.apply(this,arguments)},St)},count:function(O){var st=0;return W(O,function(){st++}),st},toArray:function(O){return W(O,function(st){return st})||[]},only:function(O){if(!V(O))throw Error("React.Children.only expected to receive a single React element child.");return O}};return oe.Activity=v,oe.Children=_t,oe.Component=x,oe.Fragment=i,oe.Profiler=l,oe.PureComponent=D,oe.StrictMode=s,oe.Suspense=m,oe.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=z,oe.__COMPILER_RUNTIME={__proto__:null,c:function(O){return z.H.useMemoCache(O)}},oe.cache=function(O){return function(){return O.apply(null,arguments)}},oe.cacheSignal=function(){return null},oe.cloneElement=function(O,st,St){if(O==null)throw Error("The argument must be a React element, but you passed "+O+".");var Et=A({},O.props),Ot=O.key;if(st!=null)for(it in st.key!==void 0&&(Ot=""+st.key),st)!G.call(st,it)||it==="key"||it==="__self"||it==="__source"||it==="ref"&&st.ref===void 0||(Et[it]=st[it]);var it=arguments.length-2;if(it===1)Et.children=St;else if(1<it){for(var ut=Array(it),Ct=0;Ct<it;Ct++)ut[Ct]=arguments[Ct+2];Et.children=ut}return w(O.type,Ot,Et)},oe.createContext=function(O){return O={$$typeof:h,_currentValue:O,_currentValue2:O,_threadCount:0,Provider:null,Consumer:null},O.Provider=O,O.Consumer={$$typeof:c,_context:O},O},oe.createElement=function(O,st,St){var Et,Ot={},it=null;if(st!=null)for(Et in st.key!==void 0&&(it=""+st.key),st)G.call(st,Et)&&Et!=="key"&&Et!=="__self"&&Et!=="__source"&&(Ot[Et]=st[Et]);var ut=arguments.length-2;if(ut===1)Ot.children=St;else if(1<ut){for(var Ct=Array(ut),It=0;It<ut;It++)Ct[It]=arguments[It+2];Ot.children=Ct}if(O&&O.defaultProps)for(Et in ut=O.defaultProps,ut)Ot[Et]===void 0&&(Ot[Et]=ut[Et]);return w(O,it,Ot)},oe.createRef=function(){return{current:null}},oe.forwardRef=function(O){return{$$typeof:d,render:O}},oe.isValidElement=V,oe.lazy=function(O){return{$$typeof:_,_payload:{_status:-1,_result:O},_init:Z}},oe.memo=function(O,st){return{$$typeof:p,type:O,compare:st===void 0?null:st}},oe.startTransition=function(O){var st=z.T,St={};z.T=St;try{var Et=O(),Ot=z.S;Ot!==null&&Ot(St,Et),typeof Et=="object"&&Et!==null&&typeof Et.then=="function"&&Et.then(N,gt)}catch(it){gt(it)}finally{st!==null&&St.types!==null&&(st.types=St.types),z.T=st}},oe.unstable_useCacheRefresh=function(){return z.H.useCacheRefresh()},oe.use=function(O){return z.H.use(O)},oe.useActionState=function(O,st,St){return z.H.useActionState(O,st,St)},oe.useCallback=function(O,st){return z.H.useCallback(O,st)},oe.useContext=function(O){return z.H.useContext(O)},oe.useDebugValue=function(){},oe.useDeferredValue=function(O,st){return z.H.useDeferredValue(O,st)},oe.useEffect=function(O,st){return z.H.useEffect(O,st)},oe.useEffectEvent=function(O){return z.H.useEffectEvent(O)},oe.useId=function(){return z.H.useId()},oe.useImperativeHandle=function(O,st,St){return z.H.useImperativeHandle(O,st,St)},oe.useInsertionEffect=function(O,st){return z.H.useInsertionEffect(O,st)},oe.useLayoutEffect=function(O,st){return z.H.useLayoutEffect(O,st)},oe.useMemo=function(O,st){return z.H.useMemo(O,st)},oe.useOptimistic=function(O,st){return z.H.useOptimistic(O,st)},oe.useReducer=function(O,st,St){return z.H.useReducer(O,st,St)},oe.useRef=function(O){return z.H.useRef(O)},oe.useState=function(O){return z.H.useState(O)},oe.useSyncExternalStore=function(O,st,St){return z.H.useSyncExternalStore(O,st,St)},oe.useTransition=function(){return z.H.useTransition()},oe.version="19.2.6",oe}var Xx;function Yd(){return Xx||(Xx=1,gh.exports=nS()),gh.exports}var ke=Yd(),_h={exports:{}},Xo={},vh={exports:{}},yh={};var kx;function iS(){return kx||(kx=1,(function(r){function t(P,W){var Z=P.length;P.push(W);t:for(;0<Z;){var gt=Z-1>>>1,_t=P[gt];if(0<l(_t,W))P[gt]=W,P[Z]=_t,Z=gt;else break t}}function i(P){return P.length===0?null:P[0]}function s(P){if(P.length===0)return null;var W=P[0],Z=P.pop();if(Z!==W){P[0]=Z;t:for(var gt=0,_t=P.length,O=_t>>>1;gt<O;){var st=2*(gt+1)-1,St=P[st],Et=st+1,Ot=P[Et];if(0>l(St,Z))Et<_t&&0>l(Ot,St)?(P[gt]=Ot,P[Et]=Z,gt=Et):(P[gt]=St,P[st]=Z,gt=st);else if(Et<_t&&0>l(Ot,Z))P[gt]=Ot,P[Et]=Z,gt=Et;else break t}}return W}function l(P,W){var Z=P.sortIndex-W.sortIndex;return Z!==0?Z:P.id-W.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;r.unstable_now=function(){return c.now()}}else{var h=Date,d=h.now();r.unstable_now=function(){return h.now()-d}}var m=[],p=[],_=1,v=null,y=3,M=!1,T=!1,A=!1,S=!1,x=typeof setTimeout=="function"?setTimeout:null,L=typeof clearTimeout=="function"?clearTimeout:null,D=typeof setImmediate<"u"?setImmediate:null;function F(P){for(var W=i(p);W!==null;){if(W.callback===null)s(p);else if(W.startTime<=P)s(p),W.sortIndex=W.expirationTime,t(m,W);else break;W=i(p)}}function k(P){if(A=!1,F(P),!T)if(i(m)!==null)T=!0,N||(N=!0,et());else{var W=i(p);W!==null&&ct(k,W.startTime-P)}}var N=!1,z=-1,G=5,w=-1;function C(){return S?!0:!(r.unstable_now()-w<G)}function V(){if(S=!1,N){var P=r.unstable_now();w=P;var W=!0;try{t:{T=!1,A&&(A=!1,L(z),z=-1),M=!0;var Z=y;try{e:{for(F(P),v=i(m);v!==null&&!(v.expirationTime>P&&C());){var gt=v.callback;if(typeof gt=="function"){v.callback=null,y=v.priorityLevel;var _t=gt(v.expirationTime<=P);if(P=r.unstable_now(),typeof _t=="function"){v.callback=_t,F(P),W=!0;break e}v===i(m)&&s(m),F(P)}else s(m);v=i(m)}if(v!==null)W=!0;else{var O=i(p);O!==null&&ct(k,O.startTime-P),W=!1}}break t}finally{v=null,y=Z,M=!1}W=void 0}}finally{W?et():N=!1}}}var et;if(typeof D=="function")et=function(){D(V)};else if(typeof MessageChannel<"u"){var ot=new MessageChannel,dt=ot.port2;ot.port1.onmessage=V,et=function(){dt.postMessage(null)}}else et=function(){x(V,0)};function ct(P,W){z=x(function(){P(r.unstable_now())},W)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(P){P.callback=null},r.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):G=0<P?Math.floor(1e3/P):5},r.unstable_getCurrentPriorityLevel=function(){return y},r.unstable_next=function(P){switch(y){case 1:case 2:case 3:var W=3;break;default:W=y}var Z=y;y=W;try{return P()}finally{y=Z}},r.unstable_requestPaint=function(){S=!0},r.unstable_runWithPriority=function(P,W){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var Z=y;y=P;try{return W()}finally{y=Z}},r.unstable_scheduleCallback=function(P,W,Z){var gt=r.unstable_now();switch(typeof Z=="object"&&Z!==null?(Z=Z.delay,Z=typeof Z=="number"&&0<Z?gt+Z:gt):Z=gt,P){case 1:var _t=-1;break;case 2:_t=250;break;case 5:_t=1073741823;break;case 4:_t=1e4;break;default:_t=5e3}return _t=Z+_t,P={id:_++,callback:W,priorityLevel:P,startTime:Z,expirationTime:_t,sortIndex:-1},Z>gt?(P.sortIndex=Z,t(p,P),i(m)===null&&P===i(p)&&(A?(L(z),z=-1):A=!0,ct(k,Z-gt))):(P.sortIndex=_t,t(m,P),T||M||(T=!0,N||(N=!0,et()))),P},r.unstable_shouldYield=C,r.unstable_wrapCallback=function(P){var W=y;return function(){var Z=y;y=W;try{return P.apply(this,arguments)}finally{y=Z}}}})(yh)),yh}var Wx;function aS(){return Wx||(Wx=1,vh.exports=iS()),vh.exports}var Sh={exports:{}},Nn={};var Yx;function sS(){if(Yx)return Nn;Yx=1;var r=Yd();function t(m){var p="https://react.dev/errors/"+m;if(1<arguments.length){p+="?args[]="+encodeURIComponent(arguments[1]);for(var _=2;_<arguments.length;_++)p+="&args[]="+encodeURIComponent(arguments[_])}return"Minified React error #"+m+"; visit "+p+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function i(){}var s={d:{f:i,r:function(){throw Error(t(522))},D:i,C:i,L:i,m:i,X:i,S:i,M:i},p:0,findDOMNode:null},l=Symbol.for("react.portal");function c(m,p,_){var v=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:l,key:v==null?null:""+v,children:m,containerInfo:p,implementation:_}}var h=r.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function d(m,p){if(m==="font")return"";if(typeof p=="string")return p==="use-credentials"?p:""}return Nn.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=s,Nn.createPortal=function(m,p){var _=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!p||p.nodeType!==1&&p.nodeType!==9&&p.nodeType!==11)throw Error(t(299));return c(m,p,null,_)},Nn.flushSync=function(m){var p=h.T,_=s.p;try{if(h.T=null,s.p=2,m)return m()}finally{h.T=p,s.p=_,s.d.f()}},Nn.preconnect=function(m,p){typeof m=="string"&&(p?(p=p.crossOrigin,p=typeof p=="string"?p==="use-credentials"?p:"":void 0):p=null,s.d.C(m,p))},Nn.prefetchDNS=function(m){typeof m=="string"&&s.d.D(m)},Nn.preinit=function(m,p){if(typeof m=="string"&&p&&typeof p.as=="string"){var _=p.as,v=d(_,p.crossOrigin),y=typeof p.integrity=="string"?p.integrity:void 0,M=typeof p.fetchPriority=="string"?p.fetchPriority:void 0;_==="style"?s.d.S(m,typeof p.precedence=="string"?p.precedence:void 0,{crossOrigin:v,integrity:y,fetchPriority:M}):_==="script"&&s.d.X(m,{crossOrigin:v,integrity:y,fetchPriority:M,nonce:typeof p.nonce=="string"?p.nonce:void 0})}},Nn.preinitModule=function(m,p){if(typeof m=="string")if(typeof p=="object"&&p!==null){if(p.as==null||p.as==="script"){var _=d(p.as,p.crossOrigin);s.d.M(m,{crossOrigin:_,integrity:typeof p.integrity=="string"?p.integrity:void 0,nonce:typeof p.nonce=="string"?p.nonce:void 0})}}else p==null&&s.d.M(m)},Nn.preload=function(m,p){if(typeof m=="string"&&typeof p=="object"&&p!==null&&typeof p.as=="string"){var _=p.as,v=d(_,p.crossOrigin);s.d.L(m,_,{crossOrigin:v,integrity:typeof p.integrity=="string"?p.integrity:void 0,nonce:typeof p.nonce=="string"?p.nonce:void 0,type:typeof p.type=="string"?p.type:void 0,fetchPriority:typeof p.fetchPriority=="string"?p.fetchPriority:void 0,referrerPolicy:typeof p.referrerPolicy=="string"?p.referrerPolicy:void 0,imageSrcSet:typeof p.imageSrcSet=="string"?p.imageSrcSet:void 0,imageSizes:typeof p.imageSizes=="string"?p.imageSizes:void 0,media:typeof p.media=="string"?p.media:void 0})}},Nn.preloadModule=function(m,p){if(typeof m=="string")if(p){var _=d(p.as,p.crossOrigin);s.d.m(m,{as:typeof p.as=="string"&&p.as!=="script"?p.as:void 0,crossOrigin:_,integrity:typeof p.integrity=="string"?p.integrity:void 0})}else s.d.m(m)},Nn.requestFormReset=function(m){s.d.r(m)},Nn.unstable_batchedUpdates=function(m,p){return m(p)},Nn.useFormState=function(m,p,_){return h.H.useFormState(m,p,_)},Nn.useFormStatus=function(){return h.H.useHostTransitionStatus()},Nn.version="19.2.6",Nn}var qx;function rS(){if(qx)return Sh.exports;qx=1;function r(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(r)}catch(t){console.error(t)}}return r(),Sh.exports=sS(),Sh.exports}var jx;function oS(){if(jx)return Xo;jx=1;var r=aS(),t=Yd(),i=rS();function s(e){var n="https://react.dev/errors/"+e;if(1<arguments.length){n+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)n+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+e+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function l(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function c(e){var n=e,a=e;if(e.alternate)for(;n.return;)n=n.return;else{e=n;do n=e,(n.flags&4098)!==0&&(a=n.return),e=n.return;while(e)}return n.tag===3?a:null}function h(e){if(e.tag===13){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function d(e){if(e.tag===31){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function m(e){if(c(e)!==e)throw Error(s(188))}function p(e){var n=e.alternate;if(!n){if(n=c(e),n===null)throw Error(s(188));return n!==e?null:e}for(var a=e,o=n;;){var u=a.return;if(u===null)break;var f=u.alternate;if(f===null){if(o=u.return,o!==null){a=o;continue}break}if(u.child===f.child){for(f=u.child;f;){if(f===a)return m(u),e;if(f===o)return m(u),n;f=f.sibling}throw Error(s(188))}if(a.return!==o.return)a=u,o=f;else{for(var g=!1,E=u.child;E;){if(E===a){g=!0,a=u,o=f;break}if(E===o){g=!0,o=u,a=f;break}E=E.sibling}if(!g){for(E=f.child;E;){if(E===a){g=!0,a=f,o=u;break}if(E===o){g=!0,o=f,a=u;break}E=E.sibling}if(!g)throw Error(s(189))}}if(a.alternate!==o)throw Error(s(190))}if(a.tag!==3)throw Error(s(188));return a.stateNode.current===a?e:n}function _(e){var n=e.tag;if(n===5||n===26||n===27||n===6)return e;for(e=e.child;e!==null;){if(n=_(e),n!==null)return n;e=e.sibling}return null}var v=Object.assign,y=Symbol.for("react.element"),M=Symbol.for("react.transitional.element"),T=Symbol.for("react.portal"),A=Symbol.for("react.fragment"),S=Symbol.for("react.strict_mode"),x=Symbol.for("react.profiler"),L=Symbol.for("react.consumer"),D=Symbol.for("react.context"),F=Symbol.for("react.forward_ref"),k=Symbol.for("react.suspense"),N=Symbol.for("react.suspense_list"),z=Symbol.for("react.memo"),G=Symbol.for("react.lazy"),w=Symbol.for("react.activity"),C=Symbol.for("react.memo_cache_sentinel"),V=Symbol.iterator;function et(e){return e===null||typeof e!="object"?null:(e=V&&e[V]||e["@@iterator"],typeof e=="function"?e:null)}var ot=Symbol.for("react.client.reference");function dt(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===ot?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case A:return"Fragment";case x:return"Profiler";case S:return"StrictMode";case k:return"Suspense";case N:return"SuspenseList";case w:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case T:return"Portal";case D:return e.displayName||"Context";case L:return(e._context.displayName||"Context")+".Consumer";case F:var n=e.render;return e=e.displayName,e||(e=n.displayName||n.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case z:return n=e.displayName||null,n!==null?n:dt(e.type)||"Memo";case G:n=e._payload,e=e._init;try{return dt(e(n))}catch{}}return null}var ct=Array.isArray,P=t.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,W=i.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,Z={pending:!1,data:null,method:null,action:null},gt=[],_t=-1;function O(e){return{current:e}}function st(e){0>_t||(e.current=gt[_t],gt[_t]=null,_t--)}function St(e,n){_t++,gt[_t]=e.current,e.current=n}var Et=O(null),Ot=O(null),it=O(null),ut=O(null);function Ct(e,n){switch(St(it,n),St(Ot,e),St(Et,null),n.nodeType){case 9:case 11:e=(e=n.documentElement)&&(e=e.namespaceURI)?cx(e):0;break;default:if(e=n.tagName,n=n.namespaceURI)n=cx(n),e=ux(n,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}st(Et),St(Et,e)}function It(){st(Et),st(Ot),st(it)}function Xt(e){e.memoizedState!==null&&St(ut,e);var n=Et.current,a=ux(n,e.type);n!==a&&(St(Ot,e),St(Et,a))}function ue(e){Ot.current===e&&(st(Et),st(Ot)),ut.current===e&&(st(ut),Fo._currentValue=Z)}var rn,pe;function Re(e){if(rn===void 0)try{throw Error()}catch(a){var n=a.stack.trim().match(/\n( *(at )?)/);rn=n&&n[1]||"",pe=-1<a.stack.indexOf(`
    at`)?" (<anonymous>)":-1<a.stack.indexOf("@")?"@unknown:0:0":""}return`
`+rn+e+pe}var I=!1;function me(e,n){if(!e||I)return"";I=!0;var a=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var o={DetermineComponentFrameRoot:function(){try{if(n){var mt=function(){throw Error()};if(Object.defineProperty(mt.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(mt,[])}catch(rt){var nt=rt}Reflect.construct(e,[],mt)}else{try{mt.call()}catch(rt){nt=rt}e.call(mt.prototype)}}else{try{throw Error()}catch(rt){nt=rt}(mt=e())&&typeof mt.catch=="function"&&mt.catch(function(){})}}catch(rt){if(rt&&nt&&typeof rt.stack=="string")return[rt.stack,nt.stack]}return[null,null]}};o.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var u=Object.getOwnPropertyDescriptor(o.DetermineComponentFrameRoot,"name");u&&u.configurable&&Object.defineProperty(o.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var f=o.DetermineComponentFrameRoot(),g=f[0],E=f[1];if(g&&E){var B=g.split(`
`),J=E.split(`
...
`].filter(el).join(`
`)),h=Wd(h),h=jg(h,i),h=Zg(h,i),d=Wd(d),d=jg(d,i),d=Zg(d,i),h=Kg(h),d=Kg(d),i.isRawShaderMaterial!==!0&&(L=`#version 300 es
...
`)+`
`+x);const D=L+S+h,F=L+x+d,k=Wg(l,l.VERTEX_SHADER,D),N=Wg(l,l.FRAGMENT_SHADER,F);l.attachShader(A,k),l.attachShader(A,N),i.index0AttributeName!==void 0?l.bindAttribLocation(A,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(A,0,"position"),l.linkProgram(A);function z(V){if(r.debug.checkShaderErrors){const et=l.getProgramInfoLog(A)||"",ot=l.getShaderInfoLog(k)||"",dt=l.getShaderInfoLog(N)||"",ct=et.trim(),P=ot.trim(),W=dt.trim();let Z=!0,gt=!0;if(l.getProgramParameter(A,l.LINK_STATUS)===!1)if(Z=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(l,A,k,N);else{const _t=qg(l,k,"vertex"),O=qg(l,N,"fragment");en("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(A,l.VALIDATE_STATUS)+`
...
}`;class AT{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,i){if(this.texture===null){const s=new H_(t.texture);(t.depthNear!==i.depthNear||t.depthFar!==i.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=s}}getMesh(t){if(this.texture!==null&&this.mesh===null){const i=t.cameras[0].viewport,s=new Ma({vertexShader:ET,fragmentShader:TT,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new Li(new ol(20,20),s)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class RT extends zs{constructor(t,i){super();const s=this;let l=null,c=1,h=null,d="local-floor",m=1,p=null,_=null,v=null,y=null,M=null,T=null;const A=typeof XRWebGLBinding<"u",S=new AT,x={},L=i.getContextAttributes();let D=null,F=null;const k=[],N=[],z=new ne;let G=null;const w=new _i;w.viewport=new sn;const C=new _i;C.viewport=new sn;const V=[w,C],et=new XM;let ot=null,dt=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(it){let ut=k[it];return ut===void 0&&(ut=new kh,k[it]=ut),ut.getTargetRaySpace()},this.getControllerGrip=function(it){let ut=k[it];return ut===void 0&&(ut=new kh,k[it]=ut),ut.getGripSpace()},this.getHand=function(it){let ut=k[it];return ut===void 0&&(ut=new kh,k[it]=ut),ut.getHandSpace()};function ct(it){const ut=N.indexOf(it.inputSource);if(ut===-1)return;const Ct=k[ut];Ct!==void 0&&(Ct.update(it.inputSource,it.frame,p||h),Ct.dispatchEvent({type:it.type,data:it.inputSource}))}function P(){l.removeEventListener("select",ct),l.removeEventListener("selectstart",ct),l.removeEventListener("selectend",ct),l.removeEventListener("squeeze",ct),l.removeEventListener("squeezestart",ct),l.removeEventListener("squeezeend",ct),l.removeEventListener("end",P),l.removeEventListener("inputsourceschange",W);for(let it=0;it<k.length;it++){const ut=N[it];ut!==null&&(N[it]=null,k[it].disconnect(ut))}ot=null,dt=null,S.reset();for(const it in x)delete x[it];t.setRenderTarget(D),M=null,y=null,v=null,l=null,F=null,Ot.stop(),s.isPresenting=!1,t.setPixelRatio(G),t.setSize(z.width,z.height,!1),s.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(it){c=it,s.isPresenting===!0&&re("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(it){d=it,s.isPresenting===!0&&re("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return p||h},this.setReferenceSpace=function(it){p=it},this.getBaseLayer=function(){return y!==null?y:M},this.getBinding=function(){return v===null&&A&&(v=new XRWebGLBinding(l,i)),v},this.getFrame=function(){return T},this.getSession=function(){return l},this.setSession=async function(it){if(l=it,l!==null){if(D=t.getRenderTarget(),l.addEventListener("select",ct),l.addEventListener("selectstart",ct),l.addEventListener("selectend",ct),l.addEventListener("squeeze",ct),l.addEventListener("squeezestart",ct),l.addEventListener("squeezeend",ct),l.addEventListener("end",P),l.addEventListener("inputsourceschange",W),L.xrCompatible!==!0&&await i.makeXRCompatible(),G=t.getPixelRatio(),t.getSize(z),A&&"createProjectionLayer"in XRWebGLBinding.prototype){let Ct=null,It=null,Xt=null;L.depth&&(Xt=L.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,Ct=L.stencil?sl:al,It=L.stencil?il:Ns);const ue={colorFormat:i.RGBA8,depthFormat:Xt,scaleFactor:c};v=this.getBinding(),y=v.createProjectionLayer(ue),l.updateRenderState({layers:[y]}),t.setPixelRatio(1),t.setSize(y.textureWidth,y.textureHeight,!1),F=new Ps(y.textureWidth,y.textureHeight,{format:wi,type:Vi,depthTexture:new I_(y.textureWidth,y.textureHeight,It,void 0,void 0,void 0,void 0,void 0,void 0,Ct),stencilBuffer:L.stencil,colorSpace:t.outputColorSpace,samples:L.antialias?4:0,resolveDepthBuffer:y.ignoreDepthValues===!1,resolveStencilBuffer:y.ignoreDepthValues===!1})}else{const Ct={antialias:L.antialias,alpha:!0,depth:L.depth,stencil:L.stencil,framebufferScaleFactor:c};M=new XRWebGLLayer(l,i,Ct),l.updateRenderState({baseLayer:M}),t.setPixelRatio(1),t.setSize(M.framebufferWidth,M.framebufferHeight,!1),F=new Ps(M.framebufferWidth,M.framebufferHeight,{format:wi,type:Vi,colorSpace:t.outputColorSpace,stencilBuffer:L.stencil,resolveDepthBuffer:M.ignoreDepthValues===!1,resolveStencilBuffer:M.ignoreDepthValues===!1})}F.isXRRenderTarget=!0,this.setFoveation(m),p=null,h=await l.requestReferenceSpace(d),Ot.setContext(l),Ot.start(),s.isPresenting=!0,s.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(l!==null)return l.environmentBlendMode},this.getDepthTexture=function(){return S.getDepthTexture()};function W(it){for(let ut=0;ut<it.removed.length;ut++){const Ct=it.removed[ut],It=N.indexOf(Ct);It>=0&&(N[It]=null,k[It].disconnect(Ct))}for(let ut=0;ut<it.added.length;ut++){const Ct=it.added[ut];let It=N.indexOf(Ct);if(It===-1){for(let ue=0;ue<k.length;ue++)if(ue>=N.length){N.push(Ct),It=ue;break}else if(N[ue]===null){N[ue]=Ct,It=ue;break}if(It===-1)break}const Xt=k[It];Xt&&Xt.connect(Ct)}}const Z=new tt,gt=new tt;function _t(it,ut,Ct){Z.setFromMatrixPosition(ut.matrixWorld),gt.setFromMatrixPosition(Ct.matrixWorld);const It=Z.distanceTo(gt),Xt=ut.projectionMatrix.elements,ue=Ct.projectionMatrix.elements,rn=Xt[14]/(Xt[10]-1),pe=Xt[14]/(Xt[10]+1),Re=(Xt[9]+1)/Xt[5],I=(Xt[9]-1)/Xt[5],me=(Xt[8]-1)/Xt[0],ge=(ue[8]+1)/ue[0],Pe=rn*me,Ht=rn*ge,Ye=It/(-me+ge),qt=Ye*-me;if(ut.matrixWorld.decompose(it.position,it.quaternion,it.scale),it.translateX(qt),it.translateZ(Ye),it.matrixWorld.compose(it.position,it.quaternion,it.scale),it.matrixWorldInverse.copy(it.matrixWorld).invert(),Xt[10]===-1)it.projectionMatrix.copy(ut.projectionMatrix),it.projectionMatrixInverse.copy(ut.projectionMatrixInverse);else{const se=rn+Ye,U=pe+Ye,b=Pe-qt,Q=Ht+(It-qt),pt=Re*pe/U*se,vt=I*pe/U*se;it.projectionMatrix.makePerspective(b,Q,pt,vt,se,U),it.projectionMatrixInverse.copy(it.projectionMatrix).invert()}}function O(it,ut){ut===null?it.matrixWorld.copy(it.matrix):it.matrixWorld.multiplyMatrices(ut.matrixWorld,it.matrix),it.matrixWorldInverse.copy(it.matrixWorld).invert()}this.updateCamera=function(it){if(l===null)return;let ut=it.near,Ct=it.far;S.texture!==null&&(S.depthNear>0&&(ut=S.depthNear),S.depthFar>0&&(Ct=S.depthFar)),et.near=C.near=w.near=ut,et.far=C.far=w.far=Ct,(ot!==et.near||dt!==et.far)&&(l.updateRenderState({depthNear:et.near,depthFar:et.far}),ot=et.near,dt=et.far),et.layers.mask=it.layers.mask|6,w.layers.mask=et.layers.mask&3,C.layers.mask=et.layers.mask&5;const It=it.parent,Xt=et.cameras;O(et,It);for(let ue=0;ue<Xt.length;ue++)O(Xt[ue],It);Xt.length===2?_t(et,w,C):et.projectionMatrix.copy(w.projectionMatrix),st(it,et,It)};function st(it,ut,Ct){Ct===null?it.matrix.copy(ut.matrixWorld):(it.matrix.copy(Ct.matrixWorld),it.matrix.invert(),it.matrix.multiply(ut.matrixWorld)),it.matrix.decompose(it.position,it.quaternion,it.scale),it.updateMatrixWorld(!0),it.projectionMatrix.copy(ut.projectionMatrix),it.projectionMatrixInverse.copy(ut.projectionMatrixInverse),it.isPerspectiveCamera&&(it.fov=Xd*2*Math.atan(1/it.projectionMatrix.elements[5]),it.zoom=1)}this.getCamera=function(){return et},this.getFoveation=function(){if(!(y===null&&M===null))return m},this.setFoveation=function(it){m=it,y!==null&&(y.fixedFoveation=it),M!==null&&M.fixedFoveation!==void 0&&(M.fixedFoveation=it)},this.hasDepthSensing=function(){return S.texture!==null},this.getDepthSensingMesh=function(){return S.getMesh(et)},this.getCameraTexture=function(it){return x[it]};let St=null;function Et(it,ut){if(_=ut.getViewerPose(p||h),T=ut,_!==null){const Ct=_.views;M!==null&&(t.setRenderTargetFramebuffer(F,M.framebuffer),t.setRenderTarget(F));let It=!1;Ct.length!==et.cameras.length&&(et.cameras.length=0,It=!0);for(let pe=0;pe<Ct.length;pe++){const Re=Ct[pe];let I=null;if(M!==null)I=M.getViewport(Re);else{const ge=v.getViewSubImage(y,Re);I=ge.viewport,pe===0&&(t.setRenderTargetTextures(F,ge.colorTexture,ge.depthStencilTexture),t.setRenderTarget(F))}let me=V[pe];me===void 0&&(me=new _i,me.layers.enable(pe),me.viewport=new sn,V[pe]=me),me.matrix.fromArray(Re.transform.matrix),me.matrix.decompose(me.position,me.quaternion,me.scale),me.projectionMatrix.fromArray(Re.projectionMatrix),me.projectionMatrixInverse.copy(me.projectionMatrix).invert(),me.viewport.set(I.x,I.y,I.width,I.height),pe===0&&(et.matrix.copy(me.matrix),et.matrix.decompose(et.position,et.quaternion,et.scale)),It===!0&&et.cameras.push(me)}const Xt=l.enabledFeatures;if(Xt&&Xt.includes("depth-sensing")&&l.depthUsage=="gpu-optimized"&&A){v=s.getBinding();const pe=v.getDepthInformation(Ct[0]);pe&&pe.isValid&&pe.texture&&S.init(pe,l.renderState)}if(Xt&&Xt.includes("camera-access")&&A){t.state.unbindTexture(),v=s.getBinding();for(let pe=0;pe<Ct.length;pe++){const Re=Ct[pe].camera;if(Re){let I=x[Re];I||(I=new H_,x[Re]=I);const me=v.getCameraImage(Re);I.sourceTexture=me}}}}for(let Ct=0;Ct<k.length;Ct++){const It=N[Ct],Xt=k[Ct];It!==null&&Xt!==void 0&&Xt.update(It,ut,p||h)}St&&St(it,ut),ut.detectedPlanes&&s.dispatchEvent({type:"planesdetected",data:ut}),T=null}const Ot=new k_;Ot.setAnimationLoop(Et),this.setAnimationLoop=function(it){St=it},this.dispose=function(){}}}const ws=new Xi,CT=new tn;function wT(r,t){function i(S,x){S.matrixAutoUpdate===!0&&S.updateMatrix(),x.value.copy(S.matrix)}function s(S,x){x.color.getRGB(S.fogColor.value,N_(r)),x.isFog?(S.fogNear.value=x.near,S.fogFar.value=x.far):x.isFogExp2&&(S.fogDensity.value=x.density)}function l(S,x,L,D,F){x.isMeshBasicMaterial||x.isMeshLambertMaterial?c(S,x):x.isMeshToonMaterial?(c(S,x),v(S,x)):x.isMeshPhongMaterial?(c(S,x),_(S,x)):x.isMeshStandardMaterial?(c(S,x),y(S,x),x.isMeshPhysicalMaterial&&M(S,x,F)):x.isMeshMatcapMaterial?(c(S,x),T(S,x)):x.isMeshDepthMaterial?c(S,x):x.isMeshDistanceMaterial?(c(S,x),A(S,x)):x.isMeshNormalMaterial?c(S,x):x.isLineBasicMaterial?(h(S,x),x.isLineDashedMaterial&&d(S,x)):x.isPointsMaterial?m(S,x,L,D):x.isSpriteMaterial?p(S,x):x.isShadowMaterial?(S.color.value.copy(x.color),S.opacity.value=x.opacity):x.isShaderMaterial&&(x.uniformsNeedUpdate=!1)}function c(S,x){S.opacity.value=x.opacity,x.color&&S.diffuse.value.copy(x.color),x.emissive&&S.emissive.value.copy(x.emissive).multiplyScalar(x.emissiveIntensity),x.map&&(S.map.value=x.map,i(x.map,S.mapTransform)),x.alphaMap&&(S.alphaMap.value=x.alphaMap,i(x.alphaMap,S.alphaMapTransform)),x.bumpMap&&(S.bumpMap.value=x.bumpMap,i(x.bumpMap,S.bumpMapTransform),S.bumpScale.value=x.bumpScale,x.side===Zn&&(S.bumpScale.value*=-1)),x.normalMap&&(S.normalMap.value=x.normalMap,i(x.normalMap,S.normalMapTransform),S.normalScale.value.copy(x.normalScale),x.side===Zn&&S.normalScale.value.negate()),x.displacementMap&&(S.displacementMap.value=x.displacementMap,i(x.displacementMap,S.displacementMapTransform),S.displacementScale.value=x.displacementScale,S.displacementBias.value=x.displacementBias),x.emissiveMap&&(S.emissiveMap.value=x.emissiveMap,i(x.emissiveMap,S.emissiveMapTransform)),x.specularMap&&(S.specularMap.value=x.specularMap,i(x.specularMap,S.specularMapTransform)),x.alphaTest>0&&(S.alphaTest.value=x.alphaTest);const L=t.get(x),D=L.envMap,F=L.envMapRotation;D&&(S.envMap.value=D,ws.copy(F),ws.x*=-1,ws.y*=-1,ws.z*=-1,D.isCubeTexture&&D.isRenderTargetTexture===!1&&(ws.y*=-1,ws.z*=-1),S.envMapRotation.value.setFromMatrix4(CT.makeRotationFromEuler(ws)),S.flipEnvMap.value=D.isCubeTexture&&D.isRenderTargetTexture===!1?-1:1,S.reflectivity.value=x.reflectivity,S.ior.value=x.ior,S.refractionRatio.value=x.refractionRatio),x.lightMap&&(S.lightMap.value=x.lightMap,S.lightMapIntensity.value=x.lightMapIntensity,i(x.lightMap,S.lightMapTransform)),x.aoMap&&(S.aoMap.value=x.aoMap,S.aoMapIntensity.value=x.aoMapIntensity,i(x.aoMap,S.aoMapTransform))}function h(S,x){S.diffuse.value.copy(x.color),S.opacity.value=x.opacity,x.map&&(S.map.value=x.map,i(x.map,S.mapTransform))}function d(S,x){S.dashSize.value=x.dashSize,S.totalSize.value=x.dashSize+x.gapSize,S.scale.value=x.scale}function m(S,x,L,D){S.diffuse.value.copy(x.color),S.opacity.value=x.opacity,S.size.value=x.size*L,S.scale.value=D*.5,x.map&&(S.map.value=x.map,i(x.map,S.uvTransform)),x.alphaMap&&(S.alphaMap.value=x.alphaMap,i(x.alphaMap,S.alphaMapTransform)),x.alphaTest>0&&(S.alphaTest.value=x.alphaTest)}function p(S,x){S.diffuse.value.copy(x.color),S.opacity.value=x.opacity,S.rotation.value=x.rotation,x.map&&(S.map.value=x.map,i(x.map,S.mapTransform)),x.alphaMap&&(S.alphaMap.value=x.alphaMap,i(x.alphaMap,S.alphaMapTransform)),x.alphaTest>0&&(S.alphaTest.value=x.alphaTest)}function _(S,x){S.specular.value.copy(x.specular),S.shininess.value=Math.max(x.shininess,1e-4)}function v(S,x){x.gradientMap&&(S.gradientMap.value=x.gradientMap)}function y(S,x){S.metalness.value=x.metalness,x.metalnessMap&&(S.metalnessMap.value=x.metalnessMap,i(x.metalnessMap,S.metalnessMapTransform)),S.roughness.value=x.roughness,x.roughnessMap&&(S.roughnessMap.value=x.roughnessMap,i(x.roughnessMap,S.roughnessMapTransform)),x.envMap&&(S.envMapIntensity.value=x.envMapIntensity)}function M(S,x,L){S.ior.value=x.ior,x.sheen>0&&(S.sheenColor.value.copy(x.sheenColor).multiplyScalar(x.sheen),S.sheenRoughness.value=x.sheenRoughness,x.sheenColorMap&&(S.sheenColorMap.value=x.sheenColorMap,i(x.sheenColorMap,S.sheenColorMapTransform)),x.sheenRoughnessMap&&(S.sheenRoughnessMap.value=x.sheenRoughnessMap,i(x.sheenRoughnessMap,S.sheenRoughnessMapTransform))),x.clearcoat>0&&(S.clearcoat.value=x.clearcoat,S.clearcoatRoughness.value=x.clearcoatRoughness,x.clearcoatMap&&(S.clearcoatMap.value=x.clearcoatMap,i(x.clearcoatMap,S.clearcoatMapTransform)),x.clearcoatRoughnessMap&&(S.clearcoatRoughnessMap.value=x.clearcoatRoughnessMap,i(x.clearcoatRoughnessMap,S.clearcoatRoughnessMapTransform)),x.clearcoatNormalMap&&(S.clearcoatNormalMap.value=x.clearcoatNormalMap,i(x.clearcoatNormalMap,S.clearcoatNormalMapTransform),S.clearcoatNormalScale.value.copy(x.clearcoatNormalScale),x.side===Zn&&S.clearcoatNormalScale.value.negate())),x.dispersion>0&&(S.dispersion.value=x.dispersion),x.iridescence>0&&(S.iridescence.value=x.iridescence,S.iridescenceIOR.value=x.iridescenceIOR,S.iridescenceThicknessMinimum.value=x.iridescenceThicknessRange[0],S.iridescenceThicknessMaximum.value=x.iridescenceThicknessRange[1],x.iridescenceMap&&(S.iridescenceMap.value=x.iridescenceMap,i(x.iridescenceMap,S.iridescenceMapTransform)),x.iridescenceThicknessMap&&(S.iridescenceThicknessMap.value=x.iridescenceThicknessMap,i(x.iridescenceThicknessMap,S.iridescenceThicknessMapTransform))),x.transmission>0&&(S.transmission.value=x.transmission,S.transmissionSamplerMap.value=L.texture,S.transmissionSamplerSize.value.set(L.width,L.height),x.transmissionMap&&(S.transmissionMap.value=x.transmissionMap,i(x.transmissionMap,S.transmissionMapTransform)),S.thickness.value=x.thickness,x.thicknessMap&&(S.thicknessMap.value=x.thicknessMap,i(x.thicknessMap,S.thicknessMapTransform)),S.attenuationDistance.value=x.attenuationDistance,S.attenuationColor.value.copy(x.attenuationColor)),x.anisotropy>0&&(S.anisotropyVector.value.set(x.anisotropy*Math.cos(x.anisotropyRotation),x.anisotropy*Math.sin(x.anisotropyRotation)),x.anisotropyMap&&(S.anisotropyMap.value=x.anisotropyMap,i(x.anisotropyMap,S.anisotropyMapTransform))),S.specularIntensity.value=x.specularIntensity,S.specularColor.value.copy(x.specularColor),x.specularColorMap&&(S.specularColorMap.value=x.specularColorMap,i(x.specularColorMap,S.specularColorMapTransform)),x.specularIntensityMap&&(S.specularIntensityMap.value=x.specularIntensityMap,i(x.specularIntensityMap,S.specularIntensityMapTransform))}function T(S,x){x.matcap&&(S.matcap.value=x.matcap)}function A(S,x){const L=t.get(x).light;S.referencePosition.value.setFromMatrixPosition(L.matrixWorld),S.nearDistance.value=L.shadow.camera.near,S.farDistance.value=L.shadow.camera.far}return{refreshFogUniforms:s,refreshMaterialUniforms:l}}function DT(r,t,i,s){let l={},c={},h=[];const d=r.getParameter(r.MAX_UNIFORM_BUFFER_BINDINGS);function m(L,D){const F=D.program;s.uniformBlockBinding(L,F)}function p(L,D){let F=l[L.id];F===void 0&&(T(L),F=_(L),l[L.id]=F,L.addEventListener("dispose",S));const k=D.program;s.updateUBOMapping(L,k);const N=t.render.frame;c[L.id]!==N&&(y(L),c[L.id]=N)}function _(L){const D=v();L.__bindingPointIndex=D;const F=r.createBuffer(),k=L.__size,N=L.usage;return r.bindBuffer(r.UNIFORM_BUFFER,F),r.bufferData(r.UNIFORM_BUFFER,k,N),r.bindBuffer(r.UNIFORM_BUFFER,null),r.bindBufferBase(r.UNIFORM_BUFFER,D,F),F}function v(){for(let L=0;L<d;L++)if(h.indexOf(L)===-1)return h.push(L),L;return en("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function y(L){const D=l[L.id],F=L.uniforms,k=L.__cache;r.bindBuffer(r.UNIFORM_BUFFER,D);for(let N=0,z=F.length;N<z;N++){const G=Array.isArray(F[N])?F[N]:[F[N]];for(let w=0,C=G.length;w<C;w++){const V=G[w];if(M(V,N,w,k)===!0){const et=V.__offset,ot=Array.isArray(V.value)?V.value:[V.value];let dt=0;for(let ct=0;ct<ot.length;ct++){const P=ot[ct],W=A(P);typeof P=="number"||typeof P=="boolean"?(V.__data[0]=P,r.bufferSubData(r.UNIFORM_BUFFER,et+dt,V.__data)):P.isMatrix3?(V.__data[0]=P.elements[0],V.__data[1]=P.elements[1],V.__data[2]=P.elements[2],V.__data[3]=0,V.__data[4]=P.elements[3],V.__data[5]=P.elements[4],V.__data[6]=P.elements[5],V.__data[7]=0,V.__data[8]=P.elements[6],V.__data[9]=P.elements[7],V.__data[10]=P.elements[8],V.__data[11]=0):(P.toArray(V.__data,dt),dt+=W.storage/Float32Array.BYTES_PER_ELEMENT)}r.bufferSubData(r.UNIFORM_BUFFER,et,V.__data)}}}r.bindBuffer(r.UNIFORM_BUFFER,null)}function M(L,D,F,k){const N=L.value,z=D+"_"+F;if(k[z]===void 0)return typeof N=="number"||typeof N=="boolean"?k[z]=N:k[z]=N.clone(),!0;{const G=k[z];if(typeof N=="number"||typeof N=="boolean"){if(G!==N)return k[z]=N,!0}else if(G.equals(N)===!1)return G.copy(N),!0}return!1}function T(L){const D=L.uniforms;let F=0;const k=16;for(let z=0,G=D.length;z<G;z++){const w=Array.isArray(D[z])?D[z]:[D[z]];for(let C=0,V=w.length;C<V;C++){const et=w[C],ot=Array.isArray(et.value)?et.value:[et.value];for(let dt=0,ct=ot.length;dt<ct;dt++){const P=ot[dt],W=A(P),Z=F%k,gt=Z%W.boundary,_t=Z+gt;F+=gt,_t!==0&&k-_t<W.storage&&(F+=k-_t),et.__data=new Float32Array(W.storage/Float32Array.BYTES_PER_ELEMENT),et.__offset=F,F+=W.storage}}}const N=F%k;return N>0&&(F+=k-N),L.__size=F,L.__cache={},this}function A(L){const D={boundary:0,storage:0};return typeof L=="number"||typeof L=="boolean"?(D.boundary=4,D.storage=4):L.isVector2?(D.boundary=8,D.storage=8):L.isVector3||L.isColor?(D.boundary=16,D.storage=12):L.isVector4?(D.boundary=16,D.storage=16):L.isMatrix3?(D.boundary=48,D.storage=48):L.isMatrix4?(D.boundary=64,D.storage=64):L.isTexture?re("WebGLRenderer: Texture samplers can not be part of an uniforms group."):re("WebGLRenderer: Unsupported uniform value type.",L),D}function S(L){const D=L.target;D.removeEventListener("dispose",S);const F=h.indexOf(D.__bindingPointIndex);h.splice(F,1),r.deleteBuffer(l[D.id]),delete l[D.id],delete c[D.id]}function x(){for(const L in l)r.deleteBuffer(l[L]);h=[],l={},c={}}return{bind:m,update:p,dispose:x}}const UT=new Uint16Array([11481,15204,11534,15171,11808,15015,12385,14843,12894,14716,13396,14600,13693,14483,13976,14366,14237,14171,14405,13961,14511,13770,14605,13598,14687,13444,14760,13305,14822,13066,14876,12857,14923,12675,14963,12517,14997,12379,15025,12230,15049,12023,15070,11843,15086,11687,15100,11551,15111,11433,15120,11330,15127,11217,15132,11060,15135,10922,15138,10801,15139,10695,15139,10600,13012,14923,13020,14917,13064,14886,13176,14800,13349,14666,13513,14526,13724,14398,13960,14230,14200,14020,14383,13827,14488,13651,14583,13491,14667,13348,14740,13132,14803,12908,14856,12713,14901,12542,14938,12394,14968,12241,14992,12017,15010,11822,15024,11654,15034,11507,15041,11380,15044,11269,15044,11081,15042,10913,15037,10764,15031,10635,15023,10520,15014,10419,15003,10330,13657,14676,13658,14673,13670,14660,13698,14622,13750,14547,13834,14442,13956,14317,14112,14093,14291,13889,14407,13704,14499,13538,14586,13389,14664,13201,14733,12966,14792,12758,14842,12577,14882,12418,14915,12272,14940,12033,14959,11826,14972,11646,14980,11490,14983,11355,14983,11212,14979,11008,14971,10830,14961,10675,14950,10540,14936,10420,14923,10315,14909,10204,14894,10041,14089,14460,14090,14459,14096,14452,14112,14431,14141,14388,14186,14305,14252,14130,14341,13941,14399,13756,14467,13585,14539,13430,14610,13272,14677,13026,14737,12808,14790,12617,14833,12449,14869,12303,14896,12065,14916,11845,14929,11655,14937,11490,14939,11347,14936,11184,14930,10970,14921,10783,14912,10621,14900,10480,14885,10356,14867,10247,14848,10062,14827,9894,14805,9745,14400,14208,14400,14206,14402,14198,14406,14174,14415,14122,14427,14035,14444,13913,14469,13767,14504,13613,14548,13463,14598,13324,14651,13082,14704,12858,14752,12658,14795,12483,14831,12330,14860,12106,14881,11875,14895,11675,14903,11501,14905,11351,14903,11178,14900,10953,14892,10757,14880,10589,14865,10442,14847,10313,14827,10162,14805,9965,14782,9792,14757,9642,14731,9507,14562,13883,14562,13883,14563,13877,14566,13862,14570,13830,14576,13773,14584,13689,14595,13582,14613,13461,14637,13336,14668,13120,14704,12897,14741,12695,14776,12516,14808,12358,14835,12150,14856,11910,14870,11701,14878,11519,14882,11361,14884,11187,14880,10951,14871,10748,14858,10572,14842,10418,14823,10286,14801,10099,14777,9897,14751,9722,14725,9567,14696,9430,14666,9309,14702,13604,14702,13604,14702,13600,14703,13591,14705,13570,14707,13533,14709,13477,14712,13400,14718,13305,14727,13106,14743,12907,14762,12716,14784,12539,14807,12380,14827,12190,14844,11943,14855,11727,14863,11539,14870,11376,14871,11204,14868,10960,14858,10748,14845,10565,14829,10406,14809,10269,14786,10058,14761,9852,14734,9671,14705,9512,14674,9374,14641,9253,14608,9076,14821,13366,14821,13365,14821,13364,14821,13358,14821,13344,14821,13320,14819,13252,14817,13145,14815,13011,14814,12858,14817,12698,14823,12539,14832,12389,14841,12214,14850,11968,14856,11750,14861,11558,14866,11390,14867,11226,14862,10972,14853,10754,14840,10565,14823,10401,14803,10259,14780,10032,14754,9820,14725,9635,14694,9473,14661,9333,14627,9203,14593,8988,14557,8798,14923,13014,14922,13014,14922,13012,14922,13004,14920,12987,14919,12957,14915,12907,14909,12834,14902,12738,14894,12623,14888,12498,14883,12370,14880,12203,14878,11970,14875,11759,14873,11569,14874,11401,14872,11243,14865,10986,14855,10762,14842,10568,14825,10401,14804,10255,14781,10017,14754,9799,14725,9611,14692,9445,14658,9301,14623,9139,14587,8920,14548,8729,14509,8562,15008,12672,15008,12672,15008,12671,15007,12667,15005,12656,15001,12637,14997,12605,14989,12556,14978,12490,14966,12407,14953,12313,14940,12136,14927,11934,14914,11742,14903,11563,14896,11401,14889,11247,14879,10992,14866,10767,14851,10570,14833,10400,14812,10252,14789,10007,14761,9784,14731,9592,14698,9424,14663,9279,14627,9088,14588,8868,14548,8676,14508,8508,14467,8360,15080,12386,15080,12386,15079,12385,15078,12383,15076,12378,15072,12367,15066,12347,15057,12315,15045,12253,15030,12138,15012,11998,14993,11845,14972,11685,14951,11530,14935,11383,14920,11228,14904,10981,14887,10762,14870,10567,14850,10397,14827,10248,14803,9997,14774,9771,14743,9578,14710,9407,14674,9259,14637,9048,14596,8826,14555,8632,14514,8464,14471,8317,14427,8182,15139,12008,15139,12008,15138,12008,15137,12007,15135,12003,15130,11990,15124,11969,15115,11929,15102,11872,15086,11794,15064,11693,15041,11581,15013,11459,14987,11336,14966,11170,14944,10944,14921,10738,14898,10552,14875,10387,14850,10239,14824,9983,14794,9758,14762,9563,14728,9392,14692,9244,14653,9014,14611,8791,14569,8597,14526,8427,14481,8281,14436,8110,14391,7885,15188,11617,15188,11617,15187,11617,15186,11618,15183,11617,15179,11612,15173,11601,15163,11581,15150,11546,15133,11495,15110,11427,15083,11346,15051,11246,15024,11057,14996,10868,14967,10687,14938,10517,14911,10362,14882,10206,14853,9956,14821,9737,14787,9543,14752,9375,14715,9228,14675,8980,14632,8760,14589,8565,14544,8395,14498,8248,14451,8049,14404,7824,14357,7630,15228,11298,15228,11298,15227,11299,15226,11301,15223,11303,15219,11302,15213,11299,15204,11290,15191,11271,15174,11217,15150,11129,15119,11015,15087,10886,15057,10744,15024,10599,14990,10455,14957,10318,14924,10143,14891,9911,14856,9701,14820,9516,14782,9352,14744,9200,14703,8946,14659,8725,14615,8533,14568,8366,14521,8220,14472,7992,14423,7770,14374,7578,14315,7408,15260,10819,15260,10819,15259,10822,15258,10826,15256,10832,15251,10836,15246,10841,15237,10838,15225,10821,15207,10788,15183,10734,15151,10660,15120,10571,15087,10469,15049,10359,15012,10249,14974,10041,14937,9837,14900,9647,14860,9475,14820,9320,14779,9147,14736,8902,14691,8688,14646,8499,14598,8335,14549,8189,14499,7940,14448,7720,14397,7529,14347,7363,14256,7218,15285,10410,15285,10411,15285,10413,15284,10418,15282,10425,15278,10434,15272,10442,15264,10449,15252,10445,15235,10433,15210,10403,15179,10358,15149,10301,15113,10218,15073,10059,15033,9894,14991,9726,14951,9565,14909,9413,14865,9273,14822,9073,14777,8845,14730,8641,14682,8459,14633,8300,14583,8129,14531,7883,14479,7670,14426,7482,14373,7321,14305,7176,14201,6939,15305,9939,15305,9940,15305,9945,15304,9955,15302,9967,15298,9989,15293,10010,15286,10033,15274,10044,15258,10045,15233,10022,15205,9975,15174,9903,15136,9808,15095,9697,15053,9578,15009,9451,14965,9327,14918,9198,14871,8973,14825,8766,14775,8579,14725,8408,14675,8259,14622,8058,14569,7821,14515,7615,14460,7435,14405,7276,14350,7108,14256,6866,14149,6653,15321,9444,15321,9445,15321,9448,15320,9458,15317,9470,15314,9490,15310,9515,15302,9540,15292,9562,15276,9579,15251,9577,15226,9559,15195,9519,15156,9463,15116,9389,15071,9304,15025,9208,14978,9023,14927,8838,14878,8661,14827,8496,14774,8344,14722,8206,14667,7973,14612,7749,14556,7555,14499,7382,14443,7229,14385,7025,14322,6791,14210,6588,14100,6409,15333,8920,15333,8921,15332,8927,15332,8943,15329,8965,15326,9002,15322,9048,15316,9106,15307,9162,15291,9204,15267,9221,15244,9221,15212,9196,15175,9134,15133,9043,15088,8930,15040,8801,14990,8665,14938,8526,14886,8391,14830,8261,14775,8087,14719,7866,14661,7664,14603,7482,14544,7322,14485,7178,14426,6936,14367,6713,14281,6517,14166,6348,14054,6198,15341,8360,15341,8361,15341,8366,15341,8379,15339,8399,15336,8431,15332,8473,15326,8527,15318,8585,15302,8632,15281,8670,15258,8690,15227,8690,15191,8664,15149,8612,15104,8543,15055,8456,15001,8360,14948,8259,14892,8122,14834,7923,14776,7734,14716,7558,14656,7397,14595,7250,14534,7070,14472,6835,14410,6628,14350,6443,14243,6283,14125,6135,14010,5889,15348,7715,15348,7717,15348,7725,15347,7745,15345,7780,15343,7836,15339,7905,15334,8e3,15326,8103,15310,8193,15293,8239,15270,8270,15240,8287,15204,8283,15163,8260,15118,8223,15067,8143,15014,8014,14958,7873,14899,7723,14839,7573,14778,7430,14715,7293,14652,7164,14588,6931,14524,6720,14460,6531,14396,6362,14330,6210,14207,6015,14086,5781,13969,5576,15352,7114,15352,7116,15352,7128,15352,7159,15350,7195,15348,7237,15345,7299,15340,7374,15332,7457,15317,7544,15301,7633,15280,7703,15251,7754,15216,7775,15176,7767,15131,7733,15079,7670,15026,7588,14967,7492,14906,7387,14844,7278,14779,7171,14714,6965,14648,6770,14581,6587,14515,6420,14448,6269,14382,6123,14299,5881,14172,5665,14049,5477,13929,5310,15355,6329,15355,6330,15355,6339,15355,6362,15353,6410,15351,6472,15349,6572,15344,6688,15337,6835,15323,6985,15309,7142,15287,7220,15260,7277,15226,7310,15188,7326,15142,7318,15090,7285,15036,7239,14976,7177,14914,7045,14849,6892,14782,6736,14714,6581,14645,6433,14576,6293,14506,6164,14438,5946,14369,5733,14270,5540,14140,5369,14014,5216,13892,5043,15357,5483,15357,5484,15357,5496,15357,5528,15356,5597,15354,5692,15351,5835,15347,6011,15339,6195,15328,6317,15314,6446,15293,6566,15268,6668,15235,6746,15197,6796,15152,6811,15101,6790,15046,6748,14985,6673,14921,6583,14854,6479,14785,6371,14714,6259,14643,6149,14571,5946,14499,5750,14428,5567,14358,5401,14242,5250,14109,5111,13980,4870,13856,4657,15359,4555,15359,4557,15358,4573,15358,4633,15357,4715,15355,4841,15353,5061,15349,5216,15342,5391,15331,5577,15318,5770,15299,5967,15274,6150,15243,6223,15206,6280,15161,6310,15111,6317,15055,6300,14994,6262,14928,6208,14860,6141,14788,5994,14715,5838,14641,5684,14566,5529,14492,5384,14418,5247,14346,5121,14216,4892,14079,4682,13948,4496,13822,4330,15359,3498,15359,3501,15359,3520,15359,3598,15358,3719,15356,3860,15355,4137,15351,4305,15344,4563,15334,4809,15321,5116,15303,5273,15280,5418,15250,5547,15214,5653,15170,5722,15120,5761,15064,5763,15002,5733,14935,5673,14865,5597,14792,5504,14716,5400,14640,5294,14563,5185,14486,5041,14410,4841,14335,4655,14191,4482,14051,4325,13918,4183,13790,4012,15360,2282,15360,2285,15360,2306,15360,2401,15359,2547,15357,2748,15355,3103,15352,3349,15345,3675,15336,4020,15324,4272,15307,4496,15285,4716,15255,4908,15220,5086,15178,5170,15128,5214,15072,5234,15010,5231,14943,5206,14871,5166,14796,5102,14718,4971,14639,4833,14559,4687,14480,4541,14402,4401,14315,4268,14167,4142,14025,3958,13888,3747,13759,3556,15360,923,15360,925,15360,946,15360,1052,15359,1214,15357,1494,15356,1892,15352,2274,15346,2663,15338,3099,15326,3393,15309,3679,15288,3980,15260,4183,15226,4325,15185,4437,15136,4517,15080,4570,15018,4591,14950,4581,14877,4545,14800,4485,14720,4411,14638,4325,14556,4231,14475,4136,14395,3988,14297,3803,14145,3628,13999,3465,13861,3314,13729,3177,15360,263,15360,264,15360,272,15360,325,15359,407,15358,548,15356,780,15352,1144,15347,1580,15339,2099,15328,2425,15312,2795,15292,3133,15264,3329,15232,3517,15191,3689,15143,3819,15088,3923,15025,3978,14956,3999,14882,3979,14804,3931,14722,3855,14639,3756,14554,3645,14470,3529,14388,3409,14279,3289,14124,3173,13975,3055,13834,2848,13701,2658,15360,49,15360,49,15360,52,15360,75,15359,111,15358,201,15356,283,15353,519,15348,726,15340,1045,15329,1415,15314,1795,15295,2173,15269,2410,15237,2649,15197,2866,15150,3054,15095,3140,15032,3196,14963,3228,14888,3236,14808,3224,14725,3191,14639,3146,14553,3088,14466,2976,14382,2836,14262,2692,14103,2549,13952,2409,13808,2278,13674,2154,15360,4,15360,4,15360,4,15360,13,15359,33,15358,59,15357,112,15353,199,15348,302,15341,456,15331,628,15316,827,15297,1082,15272,1332,15241,1601,15202,1851,15156,2069,15101,2172,15039,2256,14970,2314,14894,2348,14813,2358,14728,2344,14640,2311,14551,2263,14463,2203,14376,2133,14247,2059,14084,1915,13930,1761,13784,1609,13648,1464,15360,0,15360,0,15360,0,15360,3,15359,18,15358,26,15357,53,15354,80,15348,97,15341,165,15332,238,15318,326,15299,427,15275,529,15245,654,15207,771,15161,885,15108,994,15046,1089,14976,1170,14900,1229,14817,1266,14731,1284,14641,1282,14550,1260,14460,1223,14370,1174,14232,1116,14066,1050,13909,981,13761,910,13623,839]);let ma=null;function LT(){return ma===null&&(ma=new UM(UT,32,32,Jd,Wr),ma.minFilter=yi,ma.magFilter=yi,ma.wrapS=_a,ma.wrapT=_a,ma.generateMipmaps=!1,ma.needsUpdate=!0),ma}class NT{constructor(t={}){const{canvas:i=tM(),context:s=null,depth:l=!0,stencil:c=!1,alpha:h=!1,antialias:d=!1,premultipliedAlpha:m=!0,preserveDrawingBuffer:p=!1,powerPreference:_="default",failIfMajorPerformanceCaveat:v=!1,reversedDepthBuffer:y=!1}=t;this.isWebGLRenderer=!0;let M;if(s!==null){if(typeof WebGLRenderingContext<"u"&&s instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");M=s.getContextAttributes().alpha}else M=h;const T=new Set([tp,$d,Qd]),A=new Set([Vi,Ns,nl,il,Zd,Kd]),S=new Uint32Array(4),x=new Int32Array(4);let L=null,D=null;const F=[],k=[];this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=is,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const N=this;let z=!1;this._outputColorSpace=oi;let G=0,w=0,C=null,V=-1,et=null;const ot=new sn,dt=new sn;let ct=null;const P=new ce(0);let W=0,Z=i.width,gt=i.height,_t=1,O=null,st=null;const St=new sn(0,0,Z,gt),Et=new sn(0,0,Z,gt);let Ot=!1;const it=new ap;let ut=!1,Ct=!1;const It=new tn,Xt=new tt,ue=new sn,rn={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let pe=!1;function Re(){return C===null?_t:1}let I=s;function me(R,Y){return i.getContext(R,Y)}try{const R={alpha:!0,depth:l,stencil:c,antialias:d,premultipliedAlpha:m,preserveDrawingBuffer:p,powerPreference:_,failIfMajorPerformanceCaveat:v};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${qd}`),i.addEventListener("webglcontextlost",Mt,!1),i.addEventListener("webglcontextrestored",xt,!1),i.addEventListener("webglcontextcreationerror",zt,!1),I===null){const Y="webgl2";if(I=me(Y,R),I===null)throw me(Y)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(R){throw R("WebGLRenderer: "+R.message),R}let ge,Pe,Ht,Ye,qt,se,U,b,Q,pt,vt,lt,Wt,Ut,Qt,kt,yt,bt,Yt,Gt,Nt,ie,H,wt;function At(){ge=new G1(I),ge.init(),ie=new bT(I,ge),Pe=new L1(I,ge,t,ie),Ht=new ST(I,ge),Pe.reversedDepthBuffer&&y&&Ht.buffers.depth.setReversed(!0),Ye=new k1(I),qt=new lT,se=new MT(I,ge,Ht,qt,Pe,ie,Ye),U=new O1(N),b=new H1(N),Q=new jM(I),H=new D1(I,Q),pt=new V1(I,Q,Ye,H),vt=new Y1(I,pt,Q,Ye),Yt=new W1(I,Pe,se),kt=new N1(qt),lt=new oT(N,U,b,ge,Pe,H,kt),Wt=new wT(N,qt),Ut=new uT,Qt=new xT(ge),bt=new w1(N,U,b,Ht,vt,M,m),yt=new vT(N,vt,Pe),wt=new DT(I,Ye,Pe,Ht),Gt=new U1(I,ge,Ye),Nt=new X1(I,ge,Ye),Ye.programs=lt.programs,N.capabilities=Pe,N.extensions=ge,N.properties=qt,N.renderLists=Ut,N.shadowMap=yt,N.state=Ht,N.info=Ye}At();const Rt=new RT(N,I);this.xr=Rt,this.getContext=function(){return I},this.getContextAttributes=function(){return I.getContextAttributes()},this.forceContextLoss=function(){const R=ge.get("WEBGL_lose_context");R&&R.loseContext()},this.forceContextRestore=function(){const R=ge.get("WEBGL_lose_context");R&&R.restoreContext()},this.getPixelRatio=function(){return _t},this.setPixelRatio=function(R){R!==void 0&&(_t=R,this.setSize(Z,gt,!1))},this.getSize=function(R){return R.set(Z,gt)},this.setSize=function(R,Y,at=!0){if(Rt.isPresenting){re("WebGLRenderer: Can't change size while VR device is presenting.");return}Z=R,gt=Y,i.width=Math.floor(R*_t),i.height=Math.floor(Y*_t),at===!0&&(i.style.width=R+"px",i.style.height=Y+"px"),this.setViewport(0,0,R,Y)},this.getDrawingBufferSize=function(R){return R.set(Z*_t,gt*_t).floor()},this.setDrawingBufferSize=function(R,Y,at){Z=R,gt=Y,_t=at,i.width=Math.floor(R*at),i.height=Math.floor(Y*at),this.setViewport(0,0,R,Y)},this.getCurrentViewport=function(R){return R.copy(ot)},this.getViewport=function(R){return R.copy(St)},this.setViewport=function(R,Y,at,$){R.isVector4?St.set(R.x,R.y,R.z,R.w):St.set(R,Y,at,$),Ht.viewport(ot.copy(St).multiplyScalar(_t).round())},this.getScissor=function(R){return R.copy(Et)},this.setScissor=function(R,Y,at,$){R.isVector4?Et.set(R.x,R.y,R.z,R.w):Et.set(R,Y,at,$),Ht.scissor(dt.copy(Et).multiplyScalar(_t).round())},this.getScissorTest=function(){return Ot},this.setScissorTest=function(R){Ht.setScissorTest(Ot=R)},this.setOpaqueSort=function(R){O=R},this.setTransparentSort=function(R){st=R},this.getClearColor=function(R){return R.copy(bt.getClearColor())},this.setClearColor=function(){bt.setClearColor(...arguments)},this.getClearAlpha=function(){return bt.getClearAlpha()},this.setClearAlpha=function(){bt.setClearAlpha(...arguments)},this.clear=function(R=!0,Y=!0,at=!0){let $=0;if(R){let j=!1;if(C!==null){const Tt=C.texture.format;j=T.has(Tt)}if(j){const Tt=C.texture.type,Dt=A.has(Tt),Pt=bt.getClearColor(),Bt=bt.getClearAlpha(),$t=Pt.r,ee=Pt.g,jt=Pt.b;Dt?(S[0]=$t,S[1]=ee,S[2]=jt,S[3]=Bt,I.clearBufferuiv(I.COLOR,0,S)):(x[0]=$t,x[1]=ee,x[2]=jt,x[3]=Bt,I.clearBufferiv(I.COLOR,0,x))}else $|=I.COLOR_BUFFER_BIT}Y&&($|=I.DEPTH_BUFFER_BIT),at&&($|=I.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),I.clear($)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){i.removeEventListener("webglcontextlost",Mt,!1),i.removeEventListener("webglcontextrestored",xt,!1),i.removeEventListener("webglcontextcreationerror",zt,!1),bt.dispose(),Ut.dispose(),Qt.dispose(),qt.dispose(),U.dispose(),b.dispose(),vt.dispose(),H.dispose(),wt.dispose(),lt.dispose(),Rt.dispose(),Rt.removeEventListener("sessionstart",Zr),Rt.removeEventListener("sessionend",Kr),Mi.stop()};function Mt(R){R.preventDefault(),tu("WebGLRenderer: Context Lost."),z=!0}function xt(){tu("WebGLRenderer: Context Restored."),z=!1;const R=Ye.autoReset,Y=yt.enabled,at=yt.autoUpdate,$=yt.needsUpdate,j=yt.type;At(),Ye.autoReset=R,yt.enabled=Y,yt.autoUpdate=at,yt.needsUpdate=$,yt.type=j}function zt(R){en("WebGLRenderer: A WebGL context could not be created. Reason: ",R.statusMessage)}function ae(R){const Y=R.target;Y.removeEventListener("dispose",ae),Fe(Y)}function Fe(R){Ce(R),qt.remove(R)}function Ce(R){const Y=qt.get(R).programs;Y!==void 0&&(Y.forEach(function(at){lt.releaseProgram(at)}),R.isShaderMaterial&&lt.releaseShaderCache(R))}this.renderBufferDirect=function(R,Y,at,$,j,Tt){Y===null&&(Y=rn);const Dt=j.isMesh&&j.matrixWorld.determinant()<0,Pt=cu(R,Y,at,$,j);Ht.setMaterial($,Dt);let Bt=at.index,$t=1;if($.wireframe===!0){if(Bt=pt.getWireframeAttribute(at),Bt===void 0)return;$t=2}const ee=at.drawRange,jt=at.attributes.position;let fe=ee.start*$t,Ae=(ee.start+ee.count)*$t;Tt!==null&&(fe=Math.max(fe,Tt.start*$t),Ae=Math.min(Ae,(Tt.start+Tt.count)*$t)),Bt!==null?(fe=Math.max(fe,0),Ae=Math.min(Ae,Bt.count)):jt!=null&&(fe=Math.max(fe,0),Ae=Math.min(Ae,jt.count));const we=Ae-fe;if(we<0||we===1/0)return;H.setup(j,$,Pt,at,Bt);let be,Oe=Gt;if(Bt!==null&&(be=Q.get(Bt),Oe=Nt,Oe.setIndex(be)),j.isMesh)$.wireframe===!0?(Ht.setLineWidth($.wireframeLinewidth*Re()),Oe.setMode(I.LINES)):Oe.setMode(I.TRIANGLES);else if(j.isLine){let Jt=$.linewidth;Jt===void 0&&(Jt=1),Ht.setLineWidth(Jt*Re()),j.isLineSegments?Oe.setMode(I.LINES):j.isLineLoop?Oe.setMode(I.LINE_LOOP):Oe.setMode(I.LINE_STRIP)}else j.isPoints?Oe.setMode(I.POINTS):j.isSprite&&Oe.setMode(I.TRIANGLES);if(j.isBatchedMesh)if(j._multiDrawInstances!==null)rl("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Oe.renderMultiDrawInstances(j._multiDrawStarts,j._multiDrawCounts,j._multiDrawCount,j._multiDrawInstances);else if(ge.get("WEBGL_multi_draw"))Oe.renderMultiDraw(j._multiDrawStarts,j._multiDrawCounts,j._multiDrawCount);else{const Jt=j._multiDrawStarts,qe=j._multiDrawCounts,Ee=j._multiDrawCount,Mn=Bt?Q.get(Bt).bytesPerElement:1,Ea=qt.get($).currentProgram.getUniforms();for(let Ze=0;Ze<Ee;Ze++)Ea.setValue(I,"_gl_DrawID",Ze),Oe.render(Jt[Ze]/Mn,qe[Ze])}else if(j.isInstancedMesh)Oe.renderInstances(fe,we,j.count);else if(at.isInstancedBufferGeometry){const Jt=at._maxInstanceCount!==void 0?at._maxInstanceCount:1/0,qe=Math.min(at.instanceCount,Jt);Oe.renderInstances(fe,we,qe)}else Oe.render(fe,we)};function Ln(R,Y,at){R.transparent===!0&&R.side===ga&&R.forceSinglePass===!1?(R.side=Zn,R.needsUpdate=!0,mn(R,Y,at),R.side=ss,R.needsUpdate=!0,mn(R,Y,at),R.side=ga):mn(R,Y,at)}this.compile=function(R,Y,at=null){at===null&&(at=R),D=Qt.get(at),D.init(Y),k.push(D),at.traverseVisible(function(j){j.isLight&&j.layers.test(Y.layers)&&(D.pushLight(j),j.castShadow&&D.pushShadow(j))}),R!==at&&R.traverseVisible(function(j){j.isLight&&j.layers.test(Y.layers)&&(D.pushLight(j),j.castShadow&&D.pushShadow(j))}),D.setupLights();const $=new Set;return R.traverse(function(j){if(!(j.isMesh||j.isPoints||j.isLine||j.isSprite))return;const Tt=j.material;if(Tt)if(Array.isArray(Tt))for(let Dt=0;Dt<Tt.length;Dt++){const Pt=Tt[Dt];Ln(Pt,at,j),$.add(Pt)}else Ln(Tt,at,j),$.add(Tt)}),D=k.pop(),$},this.compileAsync=function(R,Y,at=null){const $=this.compile(R,Y,at);return new Promise(j=>{function Tt(){if($.forEach(function(Dt){qt.get(Dt).currentProgram.isReady()&&$.delete(Dt)}),$.size===0){j(R);return}setTimeout(Tt,10)}ge.get("KHR_parallel_shader_compile")!==null?Tt():setTimeout(Tt,10)})};let Kn=null;function ll(R){Kn&&Kn(R)}function Zr(){Mi.stop()}function Kr(){Mi.start()}const Mi=new k_;Mi.setAnimationLoop(ll),typeof self<"u"&&Mi.setContext(self),this.setAnimationLoop=function(R){Kn=R,Rt.setAnimationLoop(R),R===null?Mi.stop():Mi.start()},Rt.addEventListener("sessionstart",Zr),Rt.addEventListener("sessionend",Kr),this.render=function(R,Y){if(Y!==void 0&&Y.isCamera!==!0){en("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(z===!0)return;if(R.matrixWorldAutoUpdate===!0&&R.updateMatrixWorld(),Y.parent===null&&Y.matrixWorldAutoUpdate===!0&&Y.updateMatrixWorld(),Rt.enabled===!0&&Rt.isPresenting===!0&&(Rt.cameraAutoUpdate===!0&&Rt.updateCamera(Y),Y=Rt.getCamera()),R.isScene===!0&&R.onBeforeRender(N,R,Y,C),D=Qt.get(R,k.length),D.init(Y),k.push(D),It.multiplyMatrices(Y.projectionMatrix,Y.matrixWorldInverse),it.setFromProjectionMatrix(It,Gi,Y.reversedDepth),Ct=this.localClippingEnabled,ut=kt.init(this.clippingPlanes,Ct),L=Ut.get(R,F.length),L.init(),F.push(L),Rt.enabled===!0&&Rt.isPresenting===!0){const Tt=N.xr.getDepthSensingMesh();Tt!==null&&rs(Tt,Y,-1/0,N.sortObjects)}rs(R,Y,0,N.sortObjects),L.finish(),N.sortObjects===!0&&L.sort(O,st),pe=Rt.enabled===!1||Rt.isPresenting===!1||Rt.hasDepthSensing()===!1,pe&&bt.addToRenderList(L,R),this.info.render.frame++,ut===!0&&kt.beginShadows();const at=D.state.shadowsArray;yt.render(at,R,Y),ut===!0&&kt.endShadows(),this.info.autoReset===!0&&this.info.reset();const $=L.opaque,j=L.transmissive;if(D.setupLights(),Y.isArrayCamera){const Tt=Y.cameras;if(j.length>0)for(let Dt=0,Pt=Tt.length;Dt<Pt;Dt++){const Bt=Tt[Dt];Jr($,j,R,Bt)}pe&&bt.render(R);for(let Dt=0,Pt=Tt.length;Dt<Pt;Dt++){const Bt=Tt[Dt];Qr(L,R,Bt,Bt.viewport)}}else j.length>0&&Jr($,j,R,Y),pe&&bt.render(R),Qr(L,R,Y);C!==null&&w===0&&(se.updateMultisampleRenderTarget(C),se.updateRenderTargetMipmap(C)),R.isScene===!0&&R.onAfterRender(N,R,Y),H.resetDefaultState(),V=-1,et=null,k.pop(),k.length>0?(D=k[k.length-1],ut===!0&&kt.setGlobalState(N.clippingPlanes,D.state.camera)):D=null,F.pop(),F.length>0?L=F[F.length-1]:L=null};function rs(R,Y,at,$){if(R.visible===!1)return;if(R.layers.test(Y.layers)){if(R.isGroup)at=R.renderOrder;else if(R.isLOD)R.autoUpdate===!0&&R.update(Y);else if(R.isLight)D.pushLight(R),R.castShadow&&D.pushShadow(R);else if(R.isSprite){if(!R.frustumCulled||it.intersectsSprite(R)){$&&ue.setFromMatrixPosition(R.matrixWorld).applyMatrix4(It);const Dt=vt.update(R),Pt=R.material;Pt.visible&&L.push(R,Dt,Pt,at,ue.z,null)}}else if((R.isMesh||R.isLine||R.isPoints)&&(!R.frustumCulled||it.intersectsObject(R))){const Dt=vt.update(R),Pt=R.material;if($&&(R.boundingSphere!==void 0?(R.boundingSphere===null&&R.computeBoundingSphere(),ue.copy(R.boundingSphere.center)):(Dt.boundingSphere===null&&Dt.computeBoundingSphere(),ue.copy(Dt.boundingSphere.center)),ue.applyMatrix4(R.matrixWorld).applyMatrix4(It)),Array.isArray(Pt)){const Bt=Dt.groups;for(let $t=0,ee=Bt.length;$t<ee;$t++){const jt=Bt[$t],fe=Pt[jt.materialIndex];fe&&fe.visible&&L.push(R,Dt,fe,at,ue.z,jt)}}else Pt.visible&&L.push(R,Dt,Pt,at,ue.z,null)}}const Tt=R.children;for(let Dt=0,Pt=Tt.length;Dt<Pt;Dt++)rs(Tt[Dt],Y,at,$)}function Qr(R,Y,at,$){const{opaque:j,transmissive:Tt,transparent:Dt}=R;D.setupLightsView(at),ut===!0&&kt.setGlobalState(N.clippingPlanes,at),$&&Ht.viewport(ot.copy($)),j.length>0&&Qn(j,Y,at),Tt.length>0&&Qn(Tt,Y,at),Dt.length>0&&Qn(Dt,Y,at),Ht.buffers.depth.setTest(!0),Ht.buffers.depth.setMask(!0),Ht.buffers.color.setMask(!0),Ht.setPolygonOffset(!1)}function Jr(R,Y,at,$){if((at.isScene===!0?at.overrideMaterial:null)!==null)return;D.state.transmissionRenderTarget[$.id]===void 0&&(D.state.transmissionRenderTarget[$.id]=new Ps(1,1,{generateMipmaps:!0,type:ge.has("EXT_color_buffer_half_float")||ge.has("EXT_color_buffer_float")?Wr:Vi,minFilter:Ls,samples:4,stencilBuffer:c,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Le.workingColorSpace}));const Tt=D.state.transmissionRenderTarget[$.id],Dt=$.viewport||ot;Tt.setSize(Dt.z*N.transmissionResolutionScale,Dt.w*N.transmissionResolutionScale);const Pt=N.getRenderTarget(),Bt=N.getActiveCubeFace(),$t=N.getActiveMipmapLevel();N.setRenderTarget(Tt),N.getClearColor(P),W=N.getClearAlpha(),W<1&&N.setClearColor(16777215,.5),N.clear(),pe&&bt.render(at);const ee=N.toneMapping;N.toneMapping=is;const jt=$.viewport;if($.viewport!==void 0&&($.viewport=void 0),D.setupLightsView($),ut===!0&&kt.setGlobalState(N.clippingPlanes,$),Qn(R,at,$),se.updateMultisampleRenderTarget(Tt),se.updateRenderTargetMipmap(Tt),ge.has("WEBGL_multisampled_render_to_texture")===!1){let fe=!1;for(let Ae=0,we=Y.length;Ae<we;Ae++){const be=Y[Ae],{object:Oe,geometry:Jt,material:qe,group:Ee}=be;if(qe.side===ga&&Oe.layers.test($.layers)){const Mn=qe.side;qe.side=Zn,qe.needsUpdate=!0,cn(Oe,at,$,Jt,qe,Ee),qe.side=Mn,qe.needsUpdate=!0,fe=!0}}fe===!0&&(se.updateMultisampleRenderTarget(Tt),se.updateRenderTargetMipmap(Tt))}N.setRenderTarget(Pt,Bt,$t),N.setClearColor(P,W),jt!==void 0&&($.viewport=jt),N.toneMapping=ee}function Qn(R,Y,at){const $=Y.isScene===!0?Y.overrideMaterial:null;for(let j=0,Tt=R.length;j<Tt;j++){const Dt=R[j],{object:Pt,geometry:Bt,group:$t}=Dt;let ee=Dt.material;ee.allowOverride===!0&&$!==null&&(ee=$),Pt.layers.test(at.layers)&&cn(Pt,Y,at,Bt,ee,$t)}}function cn(R,Y,at,$,j,Tt){R.onBeforeRender(N,Y,at,$,j,Tt),R.modelViewMatrix.multiplyMatrices(at.matrixWorldInverse,R.matrixWorld),R.normalMatrix.getNormalMatrix(R.modelViewMatrix),j.onBeforeRender(N,Y,at,$,R,Tt),j.transparent===!0&&j.side===ga&&j.forceSinglePass===!1?(j.side=Zn,j.needsUpdate=!0,N.renderBufferDirect(at,Y,$,j,R,Tt),j.side=ss,j.needsUpdate=!0,N.renderBufferDirect(at,Y,$,j,R,Tt),j.side=ga):N.renderBufferDirect(at,Y,$,j,R,Tt),R.onAfterRender(N,Y,at,$,j,Tt)}function mn(R,Y,at){Y.isScene!==!0&&(Y=rn);const $=qt.get(R),j=D.state.lights,Tt=D.state.shadowsArray,Dt=j.state.version,Pt=lt.getParameters(R,j.state,Tt,Y,at),Bt=lt.getProgramCacheKey(Pt);let $t=$.programs;$.environment=R.isMeshStandardMaterial?Y.environment:null,$.fog=Y.fog,$.envMap=(R.isMeshStandardMaterial?b:U).get(R.envMap||$.environment),$.envMapRotation=$.environment!==null&&R.envMap===null?Y.environmentRotation:R.envMapRotation,$t===void 0&&(R.addEventListener("dispose",ae),$t=new Map,$.programs=$t);let ee=$t.get(Bt);if(ee!==void 0){if($.currentProgram===ee&&$.lightsStateVersion===Dt)return Fs(R,Pt),ee}else Pt.uniforms=lt.getUniforms(R),R.onBeforeCompile(Pt,N),ee=lt.acquireProgram(Pt,Bt),$t.set(Bt,ee),$.uniforms=Pt.uniforms;const jt=$.uniforms;return(!R.isShaderMaterial&&!R.isRawShaderMaterial||R.clipping===!0)&&(jt.clippingPlanes=kt.uniform),Fs(R,Pt),$.needsLights=cl(R),$.lightsStateVersion=Dt,$.needsLights&&(jt.ambientLightColor.value=j.state.ambient,jt.lightProbe.value=j.state.probe,jt.directionalLights.value=j.state.directional,jt.directionalLightShadows.value=j.state.directionalShadow,jt.spotLights.value=j.state.spot,jt.spotLightShadows.value=j.state.spotShadow,jt.rectAreaLights.value=j.state.rectArea,jt.ltc_1.value=j.state.rectAreaLTC1,jt.ltc_2.value=j.state.rectAreaLTC2,jt.pointLights.value=j.state.point,jt.pointLightShadows.value=j.state.pointShadow,jt.hemisphereLights.value=j.state.hemi,jt.directionalShadowMap.value=j.state.directionalShadowMap,jt.directionalShadowMatrix.value=j.state.directionalShadowMatrix,jt.spotShadowMap.value=j.state.spotShadowMap,jt.spotLightMatrix.value=j.state.spotLightMatrix,jt.spotLightMap.value=j.state.spotLightMap,jt.pointShadowMap.value=j.state.pointShadowMap,jt.pointShadowMatrix.value=j.state.pointShadowMatrix),$.currentProgram=ee,$.uniformsList=null,ee}function ki(R){if(R.uniformsList===null){const Y=R.currentProgram.getUniforms();R.uniformsList=Kc.seqWithValue(Y.seq,R.uniforms)}return R.uniformsList}function Fs(R,Y){const at=qt.get(R);at.outputColorSpace=Y.outputColorSpace,at.batching=Y.batching,at.batchingColor=Y.batchingColor,at.instancing=Y.instancing,at.instancingColor=Y.instancingColor,at.instancingMorph=Y.instancingMorph,at.skinning=Y.skinning,at.morphTargets=Y.morphTargets,at.morphNormals=Y.morphNormals,at.morphColors=Y.morphColors,at.morphTargetsCount=Y.morphTargetsCount,at.numClippingPlanes=Y.numClippingPlanes,at.numIntersection=Y.numClipIntersection,at.vertexAlphas=Y.vertexAlphas,at.vertexTangents=Y.vertexTangents,at.toneMapping=Y.toneMapping}function cu(R,Y,at,$,j){Y.isScene!==!0&&(Y=rn),se.resetTextureUnits();const Tt=Y.fog,Dt=$.isMeshStandardMaterial?Y.environment:null,Pt=C===null?N.outputColorSpace:C.isXRRenderTarget===!0?C.texture.colorSpace:Xr,Bt=($.isMeshStandardMaterial?b:U).get($.envMap||Dt),$t=$.vertexColors===!0&&!!at.attributes.color&&at.attributes.color.itemSize===4,ee=!!at.attributes.tangent&&(!!$.normalMap||$.anisotropy>0),jt=!!at.morphAttributes.position,fe=!!at.morphAttributes.normal,Ae=!!at.morphAttributes.color;let we=is;$.toneMapped&&(C===null||C.isXRRenderTarget===!0)&&(we=N.toneMapping);const be=at.morphAttributes.position||at.morphAttributes.normal||at.morphAttributes.color,Oe=be!==void 0?be.length:0,Jt=qt.get($),qe=D.state.lights;if(ut===!0&&(Ct===!0||R!==et)){const En=R===et&&$.id===V;kt.setState($,R,En)}let Ee=!1;$.version===Jt.__version?(Jt.needsLights&&Jt.lightsStateVersion!==qe.state.version||Jt.outputColorSpace!==Pt||j.isBatchedMesh&&Jt.batching===!1||!j.isBatchedMesh&&Jt.batching===!0||j.isBatchedMesh&&Jt.batchingColor===!0&&j.colorTexture===null||j.isBatchedMesh&&Jt.batchingColor===!1&&j.colorTexture!==null||j.isInstancedMesh&&Jt.instancing===!1||!j.isInstancedMesh&&Jt.instancing===!0||j.isSkinnedMesh&&Jt.skinning===!1||!j.isSkinnedMesh&&Jt.skinning===!0||j.isInstancedMesh&&Jt.instancingColor===!0&&j.instanceColor===null||j.isInstancedMesh&&Jt.instancingColor===!1&&j.instanceColor!==null||j.isInstancedMesh&&Jt.instancingMorph===!0&&j.morphTexture===null||j.isInstancedMesh&&Jt.instancingMorph===!1&&j.morphTexture!==null||Jt.envMap!==Bt||$.fog===!0&&Jt.fog!==Tt||Jt.numClippingPlanes!==void 0&&(Jt.numClippingPlanes!==kt.numPlanes||Jt.numIntersection!==kt.numIntersection)||Jt.vertexAlphas!==$t||Jt.vertexTangents!==ee||Jt.morphTargets!==jt||Jt.morphNormals!==fe||Jt.morphColors!==Ae||Jt.toneMapping!==we||Jt.morphTargetsCount!==Oe)&&(Ee=!0):(Ee=!0,Jt.__version=$.version);let Mn=Jt.currentProgram;Ee===!0&&(Mn=mn($,Y,j));let Ea=!1,Ze=!1,Wi=!1;const Ke=Mn.getUniforms(),bn=Jt.uniforms;if(Ht.useProgram(Mn.program)&&(Ea=!0,Ze=!0,Wi=!0),$.id!==V&&(V=$.id,Ze=!0),Ea||et!==R){Ht.buffers.depth.getReversed()&&R.reversedDepth!==!0&&(R._reversedDepth=!0,R.updateProjectionMatrix()),Ke.setValue(I,"projectionMatrix",R.projectionMatrix),Ke.setValue(I,"viewMatrix",R.matrixWorldInverse);const Rn=Ke.map.cameraPosition;Rn!==void 0&&Rn.setValue(I,Xt.setFromMatrixPosition(R.matrixWorld)),Pe.logarithmicDepthBuffer&&Ke.setValue(I,"logDepthBufFC",2/(Math.log(R.far+1)/Math.LN2)),($.isMeshPhongMaterial||$.isMeshToonMaterial||$.isMeshLambertMaterial||$.isMeshBasicMaterial||$.isMeshStandardMaterial||$.isShaderMaterial)&&Ke.setValue(I,"isOrthographic",R.isOrthographicCamera===!0),et!==R&&(et=R,Ze=!0,Wi=!0)}if(j.isSkinnedMesh){Ke.setOptional(I,j,"bindMatrix"),Ke.setOptional(I,j,"bindMatrixInverse");const En=j.skeleton;En&&(En.boneTexture===null&&En.computeBoneTexture(),Ke.setValue(I,"boneTexture",En.boneTexture,se))}j.isBatchedMesh&&(Ke.setOptional(I,j,"batchingTexture"),Ke.setValue(I,"batchingTexture",j._matricesTexture,se),Ke.setOptional(I,j,"batchingIdTexture"),Ke.setValue(I,"batchingIdTexture",j._indirectTexture,se),Ke.setOptional(I,j,"batchingColorTexture"),j._colorsTexture!==null&&Ke.setValue(I,"batchingColorTexture",j._colorsTexture,se));const xn=at.morphAttributes;if((xn.position!==void 0||xn.normal!==void 0||xn.color!==void 0)&&Yt.update(j,at,Mn),(Ze||Jt.receiveShadow!==j.receiveShadow)&&(Jt.receiveShadow=j.receiveShadow,Ke.setValue(I,"receiveShadow",j.receiveShadow)),$.isMeshGouraudMaterial&&$.envMap!==null&&(bn.envMap.value=Bt,bn.flipEnvMap.value=Bt.isCubeTexture&&Bt.isRenderTargetTexture===!1?-1:1),$.isMeshStandardMaterial&&$.envMap===null&&Y.environment!==null&&(bn.envMapIntensity.value=Y.environmentIntensity),bn.dfgLUT!==void 0&&(bn.dfgLUT.value=LT()),Ze&&(Ke.setValue(I,"toneMappingExposure",N.toneMappingExposure),Jt.needsLights&&uu(bn,Wi),Tt&&$.fog===!0&&Wt.refreshFogUniforms(bn,Tt),Wt.refreshMaterialUniforms(bn,$,_t,gt,D.state.transmissionRenderTarget[R.id]),Kc.upload(I,ki(Jt),bn,se)),$.isShaderMaterial&&$.uniformsNeedUpdate===!0&&(Kc.upload(I,ki(Jt),bn,se),$.uniformsNeedUpdate=!1),$.isSpriteMaterial&&Ke.setValue(I,"center",j.center),Ke.setValue(I,"modelViewMatrix",j.modelViewMatrix),Ke.setValue(I,"normalMatrix",j.normalMatrix),Ke.setValue(I,"modelMatrix",j.matrixWorld),$.isShaderMaterial||$.isRawShaderMaterial){const En=$.uniformsGroups;for(let Rn=0,Oi=En.length;Rn<Oi;Rn++){const Yi=En[Rn];wt.update(Yi,Mn),wt.bind(Yi,Mn)}}return Mn}function uu(R,Y){R.ambientLightColor.needsUpdate=Y,R.lightProbe.needsUpdate=Y,R.directionalLights.needsUpdate=Y,R.directionalLightShadows.needsUpdate=Y,R.pointLights.needsUpdate=Y,R.pointLightShadows.needsUpdate=Y,R.spotLights.needsUpdate=Y,R.spotLightShadows.needsUpdate=Y,R.rectAreaLights.needsUpdate=Y,R.hemisphereLights.needsUpdate=Y}function cl(R){return R.isMeshLambertMaterial||R.isMeshToonMaterial||R.isMeshPhongMaterial||R.isMeshStandardMaterial||R.isShadowMaterial||R.isShaderMaterial&&R.lights===!0}this.getActiveCubeFace=function(){return G},this.getActiveMipmapLevel=function(){return w},this.getRenderTarget=function(){return C},this.setRenderTargetTextures=function(R,Y,at){const $=qt.get(R);$.__autoAllocateDepthBuffer=R.resolveDepthBuffer===!1,$.__autoAllocateDepthBuffer===!1&&($.__useRenderToTexture=!1),qt.get(R.texture).__webglTexture=Y,qt.get(R.depthTexture).__webglTexture=$.__autoAllocateDepthBuffer?void 0:at,$.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(R,Y){const at=qt.get(R);at.__webglFramebuffer=Y,at.__useDefaultFramebuffer=Y===void 0};const os=I.createFramebuffer();this.setRenderTarget=function(R,Y=0,at=0){C=R,G=Y,w=at;let $=!0,j=null,Tt=!1,Dt=!1;if(R){const Bt=qt.get(R);if(Bt.__useDefaultFramebuffer!==void 0)Ht.bindFramebuffer(I.FRAMEBUFFER,null),$=!1;else if(Bt.__webglFramebuffer===void 0)se.setupRenderTarget(R);else if(Bt.__hasExternalTextures)se.rebindTextures(R,qt.get(R.texture).__webglTexture,qt.get(R.depthTexture).__webglTexture);else if(R.depthBuffer){const jt=R.depthTexture;if(Bt.__boundDepthTexture!==jt){if(jt!==null&&qt.has(jt)&&(R.width!==jt.image.width||R.height!==jt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");se.setupDepthRenderbuffer(R)}}const $t=R.texture;($t.isData3DTexture||$t.isDataArrayTexture||$t.isCompressedArrayTexture)&&(Dt=!0);const ee=qt.get(R).__webglFramebuffer;R.isWebGLCubeRenderTarget?(Array.isArray(ee[Y])?j=ee[Y][at]:j=ee[Y],Tt=!0):R.samples>0&&se.useMultisampledRTT(R)===!1?j=qt.get(R).__webglMultisampledFramebuffer:Array.isArray(ee)?j=ee[at]:j=ee,ot.copy(R.viewport),dt.copy(R.scissor),ct=R.scissorTest}else ot.copy(St).multiplyScalar(_t).floor(),dt.copy(Et).multiplyScalar(_t).floor(),ct=Ot;if(at!==0&&(j=os),Ht.bindFramebuffer(I.FRAMEBUFFER,j)&&$&&Ht.drawBuffers(R,j),Ht.viewport(ot),Ht.scissor(dt),Ht.setScissorTest(ct),Tt){const Bt=qt.get(R.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_CUBE_MAP_POSITIVE_X+Y,Bt.__webglTexture,at)}else if(Dt){const Bt=Y;for(let $t=0;$t<R.textures.length;$t++){const ee=qt.get(R.textures[$t]);I.framebufferTextureLayer(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0+$t,ee.__webglTexture,at,Bt)}}else if(R!==null&&at!==0){const Bt=qt.get(R.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,Bt.__webglTexture,at)}V=-1},this.readRenderTargetPixels=function(R,Y,at,$,j,Tt,Dt,Pt=0){if(!(R&&R.isWebGLRenderTarget)){en("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Bt=qt.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget&&Dt!==void 0&&(Bt=Bt[Dt]),Bt){Ht.bindFramebuffer(I.FRAMEBUFFER,Bt);try{const $t=R.textures[Pt],ee=$t.format,jt=$t.type;if(!Pe.textureFormatReadable(ee)){en("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Pe.textureTypeReadable(jt)){en("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}Y>=0&&Y<=R.width-$&&at>=0&&at<=R.height-j&&(R.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+Pt),I.readPixels(Y,at,$,j,ie.convert(ee),ie.convert(jt),Tt))}finally{const $t=C!==null?qt.get(C).__webglFramebuffer:null;Ht.bindFramebuffer(I.FRAMEBUFFER,$t)}}},this.readRenderTargetPixelsAsync=async function(R,Y,at,$,j,Tt,Dt,Pt=0){if(!(R&&R.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Bt=qt.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget&&Dt!==void 0&&(Bt=Bt[Dt]),Bt)if(Y>=0&&Y<=R.width-$&&at>=0&&at<=R.height-j){Ht.bindFramebuffer(I.FRAMEBUFFER,Bt);const $t=R.textures[Pt],ee=$t.format,jt=$t.type;if(!Pe.textureFormatReadable(ee))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Pe.textureTypeReadable(jt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const fe=I.createBuffer();I.bindBuffer(I.PIXEL_PACK_BUFFER,fe),I.bufferData(I.PIXEL_PACK_BUFFER,Tt.byteLength,I.STREAM_READ),R.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+Pt),I.readPixels(Y,at,$,j,ie.convert(ee),ie.convert(jt),0);const Ae=C!==null?qt.get(C).__webglFramebuffer:null;Ht.bindFramebuffer(I.FRAMEBUFFER,Ae);const we=I.fenceSync(I.SYNC_GPU_COMMANDS_COMPLETE,0);return I.flush(),await eM(I,we,4),I.bindBuffer(I.PIXEL_PACK_BUFFER,fe),I.getBufferSubData(I.PIXEL_PACK_BUFFER,0,Tt),I.deleteBuffer(fe),I.deleteSync(we),Tt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(R,Y=null,at=0){const $=Math.pow(2,-at),j=Math.floor(R.image.width*$),Tt=Math.floor(R.image.height*$),Dt=Y!==null?Y.x:0,Pt=Y!==null?Y.y:0;se.setTexture2D(R,0),I.copyTexSubImage2D(I.TEXTURE_2D,at,0,0,Dt,Pt,j,Tt),Ht.unbindTexture()};const $r=I.createFramebuffer(),ba=I.createFramebuffer();this.copyTextureToTexture=function(R,Y,at=null,$=null,j=0,Tt=null){Tt===null&&(j!==0?(rl("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Tt=j,j=0):Tt=0);let Dt,Pt,Bt,$t,ee,jt,fe,Ae,we;const be=R.isCompressedTexture?R.mipmaps[Tt]:R.image;if(at!==null)Dt=at.max.x-at.min.x,Pt=at.max.y-at.min.y,Bt=at.isBox3?at.max.z-at.min.z:1,$t=at.min.x,ee=at.min.y,jt=at.isBox3?at.min.z:0;else{const xn=Math.pow(2,-j);Dt=Math.floor(be.width*xn),Pt=Math.floor(be.height*xn),R.isDataArrayTexture?Bt=be.depth:R.isData3DTexture?Bt=Math.floor(be.depth*xn):Bt=1,$t=0,ee=0,jt=0}$!==null?(fe=$.x,Ae=$.y,we=$.z):(fe=0,Ae=0,we=0);const Oe=ie.convert(Y.format),Jt=ie.convert(Y.type);let qe;Y.isData3DTexture?(se.setTexture3D(Y,0),qe=I.TEXTURE_3D):Y.isDataArrayTexture||Y.isCompressedArrayTexture?(se.setTexture2DArray(Y,0),qe=I.TEXTURE_2D_ARRAY):(se.setTexture2D(Y,0),qe=I.TEXTURE_2D),I.pixelStorei(I.UNPACK_FLIP_Y_WEBGL,Y.flipY),I.pixelStorei(I.UNPACK_PREMULTIPLY_ALPHA_WEBGL,Y.premultiplyAlpha),I.pixelStorei(I.UNPACK_ALIGNMENT,Y.unpackAlignment);const Ee=I.getParameter(I.UNPACK_ROW_LENGTH),Mn=I.getParameter(I.UNPACK_IMAGE_HEIGHT),Ea=I.getParameter(I.UNPACK_SKIP_PIXELS),Ze=I.getParameter(I.UNPACK_SKIP_ROWS),Wi=I.getParameter(I.UNPACK_SKIP_IMAGES);I.pixelStorei(I.UNPACK_ROW_LENGTH,be.width),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,be.height),I.pixelStorei(I.UNPACK_SKIP_PIXELS,$t),I.pixelStorei(I.UNPACK_SKIP_ROWS,ee),I.pixelStorei(I.UNPACK_SKIP_IMAGES,jt);const Ke=R.isDataArrayTexture||R.isData3DTexture,bn=Y.isDataArrayTexture||Y.isData3DTexture;if(R.isDepthTexture){const xn=qt.get(R),En=qt.get(Y),Rn=qt.get(xn.__renderTarget),Oi=qt.get(En.__renderTarget);Ht.bindFramebuffer(I.READ_FRAMEBUFFER,Rn.__webglFramebuffer),Ht.bindFramebuffer(I.DRAW_FRAMEBUFFER,Oi.__webglFramebuffer);for(let Yi=0;Yi<Bt;Yi++)Ke&&(I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,qt.get(R).__webglTexture,j,jt+Yi),I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,qt.get(Y).__webglTexture,Tt,we+Yi)),I.blitFramebuffer($t,ee,Dt,Pt,fe,Ae,Dt,Pt,I.DEPTH_BUFFER_BIT,I.NEAREST);Ht.bindFramebuffer(I.READ_FRAMEBUFFER,null),Ht.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else if(j!==0||R.isRenderTargetTexture||qt.has(R)){const xn=qt.get(R),En=qt.get(Y);Ht.bindFramebuffer(I.READ_FRAMEBUFFER,$r),Ht.bindFramebuffer(I.DRAW_FRAMEBUFFER,ba);for(let Rn=0;Rn<Bt;Rn++)Ke?I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,xn.__webglTexture,j,jt+Rn):I.framebufferTexture2D(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,xn.__webglTexture,j),bn?I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,En.__webglTexture,Tt,we+Rn):I.framebufferTexture2D(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,En.__webglTexture,Tt),j!==0?I.blitFramebuffer($t,ee,Dt,Pt,fe,Ae,Dt,Pt,I.COLOR_BUFFER_BIT,I.NEAREST):bn?I.copyTexSubImage3D(qe,Tt,fe,Ae,we+Rn,$t,ee,Dt,Pt):I.copyTexSubImage2D(qe,Tt,fe,Ae,$t,ee,Dt,Pt);Ht.bindFramebuffer(I.READ_FRAMEBUFFER,null),Ht.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else bn?R.isDataTexture||R.isData3DTexture?I.texSubImage3D(qe,Tt,fe,Ae,we,Dt,Pt,Bt,Oe,Jt,be.data):Y.isCompressedArrayTexture?I.compressedTexSubImage3D(qe,Tt,fe,Ae,we,Dt,Pt,Bt,Oe,be.data):I.texSubImage3D(qe,Tt,fe,Ae,we,Dt,Pt,Bt,Oe,Jt,be):R.isDataTexture?I.texSubImage2D(I.TEXTURE_2D,Tt,fe,Ae,Dt,Pt,Oe,Jt,be.data):R.isCompressedTexture?I.compressedTexSubImage2D(I.TEXTURE_2D,Tt,fe,Ae,be.width,be.height,Oe,be.data):I.texSubImage2D(I.TEXTURE_2D,Tt,fe,Ae,Dt,Pt,Oe,Jt,be);I.pixelStorei(I.UNPACK_ROW_LENGTH,Ee),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,Mn),I.pixelStorei(I.UNPACK_SKIP_PIXELS,Ea),I.pixelStorei(I.UNPACK_SKIP_ROWS,Ze),I.pixelStorei(I.UNPACK_SKIP_IMAGES,Wi),Tt===0&&Y.generateMipmaps&&I.generateMipmap(qe),Ht.unbindTexture()},this.initRenderTarget=function(R){qt.get(R).__webglFramebuffer===void 0&&se.setupRenderTarget(R)},this.initTexture=function(R){R.isCubeTexture?se.setTextureCube(R,0):R.isData3DTexture?se.setTexture3D(R,0):R.isDataArrayTexture||R.isCompressedArrayTexture?se.setTexture2DArray(R,0):se.setTexture2D(R,0),Ht.unbindTexture()},this.resetState=function(){G=0,w=0,C=null,Ht.reset(),H.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Gi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const i=this.getContext();i.drawingBufferColorSpace=Le._getDrawingBufferColorSpace(t),i.unpackColorSpace=Le._getUnpackColorSpace()}}const e_={type:"change"},sp={type:"start"},Z_={type:"end"},kc=new ru,n_=new ts,OT=Math.cos(70*iM.DEG2RAD),_n=new tt,qn=2*Math.PI,We={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},td=1e-6;class PT extends YM{constructor(t,i=null){super(t,i),this.state=We.NONE,this.target=new tt,this.cursor=new tt,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Br.ROTATE,MIDDLE:Br.DOLLY,RIGHT:Br.PAN},this.touches={ONE:Pr.ROTATE,TWO:Pr.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this._lastPosition=new tt,this._lastQuaternion=new Os,this._lastTargetPosition=new tt,this._quat=new Os().setFromUnitVectors(t.up,new tt(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new Dg,this._sphericalDelta=new Dg,this._scale=1,this._panOffset=new tt,this._rotateStart=new ne,this._rotateEnd=new ne,this._rotateDelta=new ne,this._panStart=new ne,this._panEnd=new ne,this._panDelta=new ne,this._dollyStart=new ne,this._dollyEnd=new ne,this._dollyDelta=new ne,this._dollyDirection=new tt,this._mouse=new ne,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=BT.bind(this),this._onPointerDown=zT.bind(this),this._onPointerUp=FT.bind(this),this._onContextMenu=WT.bind(this),this._onMouseWheel=GT.bind(this),this._onKeyDown=VT.bind(this),this._onTouchStart=XT.bind(this),this._onTouchMove=kT.bind(this),this._onMouseDown=IT.bind(this),this._onMouseMove=HT.bind(this),this._interceptControlDown=YT.bind(this),this._interceptControlUp=qT.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}connect(t){super.connect(t),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(t){t.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=t}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(e_),this.update(),this.state=We.NONE}update(t=null){const i=this.object.position;_n.copy(i).sub(this.target),_n.applyQuaternion(this._quat),this._spherical.setFromVector3(_n),this.autoRotate&&this.state===We.NONE&&this._rotateLeft(this._getAutoRotationAngle(t)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let s=this.minAzimuthAngle,l=this.maxAzimuthAngle;isFinite(s)&&isFinite(l)&&(s<-Math.PI?s+=qn:s>Math.PI&&(s-=qn),l<-Math.PI?l+=qn:l>Math.PI&&(l-=qn),s<=l?this._spherical.theta=Math.max(s,Math.min(l,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(s+l)/2?Math.max(s,this._spherical.theta):Math.min(l,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let c=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const h=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),c=h!=this._spherical.radius}if(_n.setFromSpherical(this._spherical),_n.applyQuaternion(this._quatInverse),i.copy(this.target).add(_n),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let h=null;if(this.object.isPerspectiveCamera){const d=_n.length();h=this._clampDistance(d*this._scale);const m=d-h;this.object.position.addScaledVector(this._dollyDirection,m),this.object.updateMatrixWorld(),c=!!m}else if(this.object.isOrthographicCamera){const d=new tt(this._mouse.x,this._mouse.y,0);d.unproject(this.object);const m=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),c=m!==this.object.zoom;const p=new tt(this._mouse.x,this._mouse.y,0);p.unproject(this.object),this.object.position.sub(p).add(d),this.object.updateMatrixWorld(),h=_n.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;h!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(h).add(this.object.position):(kc.origin.copy(this.object.position),kc.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(kc.direction))<OT?this.object.lookAt(this.target):(n_.setFromNormalAndCoplanarPoint(this.object.up,this.target),kc.intersectPlane(n_,this.target))))}else if(this.object.isOrthographicCamera){const h=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),h!==this.object.zoom&&(this.object.updateProjectionMatrix(),c=!0)}return this._scale=1,this._performCursorZoom=!1,c||this._lastPosition.distanceToSquared(this.object.position)>td||8*(1-this._lastQuaternion.dot(this.object.quaternion))>td||this._lastTargetPosition.distanceToSquared(this.target)>td?(this.dispatchEvent(e_),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(t){return t!==null?qn/60*this.autoRotateSpeed*t:qn/60/60*this.autoRotateSpeed}_getZoomScale(t){const i=Math.abs(t*.01);return Math.pow(.95,this.zoomSpeed*i)}_rotateLeft(t){this._sphericalDelta.theta-=t}_rotateUp(t){this._sphericalDelta.phi-=t}_panLeft(t,i){_n.setFromMatrixColumn(i,0),_n.multiplyScalar(-t),this._panOffset.add(_n)}_panUp(t,i){this.screenSpacePanning===!0?_n.setFromMatrixColumn(i,1):(_n.setFromMatrixColumn(i,0),_n.crossVectors(this.object.up,_n)),_n.multiplyScalar(t),this._panOffset.add(_n)}_pan(t,i){const s=this.domElement;if(this.object.isPerspectiveCamera){const l=this.object.position;_n.copy(l).sub(this.target);let c=_n.length();c*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*t*c/s.clientHeight,this.object.matrix),this._panUp(2*i*c/s.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(t*(this.object.right-this.object.left)/this.object.zoom/s.clientWidth,this.object.matrix),this._panUp(i*(this.object.top-this.object.bottom)/this.object.zoom/s.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(t,i){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const s=this.domElement.getBoundingClientRect(),l=t-s.left,c=i-s.top,h=s.width,d=s.height;this._mouse.x=l/h*2-1,this._mouse.y=-(c/d)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(t){return Math.max(this.minDistance,Math.min(this.maxDistance,t))}_handleMouseDownRotate(t){this._rotateStart.set(t.clientX,t.clientY)}_handleMouseDownDolly(t){this._updateZoomParameters(t.clientX,t.clientX),this._dollyStart.set(t.clientX,t.clientY)}_handleMouseDownPan(t){this._panStart.set(t.clientX,t.clientY)}_handleMouseMoveRotate(t){this._rotateEnd.set(t.clientX,t.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const i=this.domElement;this._rotateLeft(qn*this._rotateDelta.x/i.clientHeight),this._rotateUp(qn*this._rotateDelta.y/i.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(t){this._dollyEnd.set(t.clientX,t.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(t){this._panEnd.set(t.clientX,t.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(t){this._updateZoomParameters(t.clientX,t.clientY),t.deltaY<0?this._dollyIn(this._getZoomScale(t.deltaY)):t.deltaY>0&&this._dollyOut(this._getZoomScale(t.deltaY)),this.update()}_handleKeyDown(t){let i=!1;switch(t.code){case this.keys.UP:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(qn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),i=!0;break;case this.keys.BOTTOM:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(-qn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),i=!0;break;case this.keys.LEFT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(qn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),i=!0;break;case this.keys.RIGHT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(-qn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),i=!0;break}i&&(t.preventDefault(),this.update())}_handleTouchStartRotate(t){if(this._pointers.length===1)this._rotateStart.set(t.pageX,t.pageY);else{const i=this._getSecondPointerPosition(t),s=.5*(t.pageX+i.x),l=.5*(t.pageY+i.y);this._rotateStart.set(s,l)}}_handleTouchStartPan(t){if(this._pointers.length===1)this._panStart.set(t.pageX,t.pageY);else{const i=this._getSecondPointerPosition(t),s=.5*(t.pageX+i.x),l=.5*(t.pageY+i.y);this._panStart.set(s,l)}}_handleTouchStartDolly(t){const i=this._getSecondPointerPosition(t),s=t.pageX-i.x,l=t.pageY-i.y,c=Math.sqrt(s*s+l*l);this._dollyStart.set(0,c)}_handleTouchStartDollyPan(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enablePan&&this._handleTouchStartPan(t)}_handleTouchStartDollyRotate(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enableRotate&&this._handleTouchStartRotate(t)}_handleTouchMoveRotate(t){if(this._pointers.length==1)this._rotateEnd.set(t.pageX,t.pageY);else{const s=this._getSecondPointerPosition(t),l=.5*(t.pageX+s.x),c=.5*(t.pageY+s.y);this._rotateEnd.set(l,c)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const i=this.domElement;this._rotateLeft(qn*this._rotateDelta.x/i.clientHeight),this._rotateUp(qn*this._rotateDelta.y/i.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(t){if(this._pointers.length===1)this._panEnd.set(t.pageX,t.pageY);else{const i=this._getSecondPointerPosition(t),s=.5*(t.pageX+i.x),l=.5*(t.pageY+i.y);this._panEnd.set(s,l)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(t){const i=this._getSecondPointerPosition(t),s=t.pageX-i.x,l=t.pageY-i.y,c=Math.sqrt(s*s+l*l);this._dollyEnd.set(0,c),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const h=(t.pageX+i.x)*.5,d=(t.pageY+i.y)*.5;this._updateZoomParameters(h,d)}_handleTouchMoveDollyPan(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enablePan&&this._handleTouchMovePan(t)}_handleTouchMoveDollyRotate(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enableRotate&&this._handleTouchMoveRotate(t)}_addPointer(t){this._pointers.push(t.pointerId)}_removePointer(t){delete this._pointerPositions[t.pointerId];for(let i=0;i<this._pointers.length;i++)if(this._pointers[i]==t.pointerId){this._pointers.splice(i,1);return}}_isTrackingPointer(t){for(let i=0;i<this._pointers.length;i++)if(this._pointers[i]==t.pointerId)return!0;return!1}_trackPointer(t){let i=this._pointerPositions[t.pointerId];i===void 0&&(i=new ne,this._pointerPositions[t.pointerId]=i),i.set(t.pageX,t.pageY)}_getSecondPointerPosition(t){const i=t.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[i]}_customWheelEvent(t){const i=t.deltaMode,s={clientX:t.clientX,clientY:t.clientY,deltaY:t.deltaY};switch(i){case 1:s.deltaY*=16;break;case 2:s.deltaY*=100;break}return t.ctrlKey&&!this._controlActive&&(s.deltaY*=10),s}}function zT(r){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(r.pointerId),this.domElement.addEventListener("pointermove",this._onPointerMove),this.domElement.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(r)&&(this._addPointer(r),r.pointerType==="touch"?this._onTouchStart(r):this._onMouseDown(r)))}function BT(r){this.enabled!==!1&&(r.pointerType==="touch"?this._onTouchMove(r):this._onMouseMove(r))}function FT(r){switch(this._removePointer(r),this._pointers.length){case 0:this.domElement.releasePointerCapture(r.pointerId),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(Z_),this.state=We.NONE;break;case 1:const t=this._pointers[0],i=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:i.x,pageY:i.y});break}}function IT(r){let t;switch(r.button){case 0:t=this.mouseButtons.LEFT;break;case 1:t=this.mouseButtons.MIDDLE;break;case 2:t=this.mouseButtons.RIGHT;break;default:t=-1}switch(t){case Br.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(r),this.state=We.DOLLY;break;case Br.ROTATE:if(r.ctrlKey||r.metaKey||r.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(r),this.state=We.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(r),this.state=We.ROTATE}break;case Br.PAN:if(r.ctrlKey||r.metaKey||r.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(r),this.state=We.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(r),this.state=We.PAN}break;default:this.state=We.NONE}this.state!==We.NONE&&this.dispatchEvent(sp)}function HT(r){switch(this.state){case We.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(r);break;case We.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(r);break;case We.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(r);break}}function GT(r){this.enabled===!1||this.enableZoom===!1||this.state!==We.NONE||(r.preventDefault(),this.dispatchEvent(sp),this._handleMouseWheel(this._customWheelEvent(r)),this.dispatchEvent(Z_))}function VT(r){this.enabled!==!1&&this._handleKeyDown(r)}function XT(r){switch(this._trackPointer(r),this._pointers.length){case 1:switch(this.touches.ONE){case Pr.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(r),this.state=We.TOUCH_ROTATE;break;case Pr.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(r),this.state=We.TOUCH_PAN;break;default:this.state=We.NONE}break;case 2:switch(this.touches.TWO){case Pr.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(r),this.state=We.TOUCH_DOLLY_PAN;break;case Pr.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(r),this.state=We.TOUCH_DOLLY_ROTATE;break;default:this.state=We.NONE}break;default:this.state=We.NONE}this.state!==We.NONE&&this.dispatchEvent(sp)}function kT(r){switch(this._trackPointer(r),this.state){case We.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(r),this.update();break;case We.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(r),this.update();break;case We.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(r),this.update();break;case We.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(r),this.update();break;default:this.state=We.NONE}}function WT(r){this.enabled!==!1&&r.preventDefault()}function YT(r){r.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function qT(r){r.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}const jT=new ce("#60a5fa"),ZT=new ce("#facc15"),KT=new ce("#f97316");function QT(r,t,i,s=new Set){r.forEach(l=>{if(l.userData.locationId===i){l.material.color.copy(KT),l.material.emissive.set("#7c2d12"),l.material.emissiveIntensity=.35;return}if(l.userData.locationId===t){l.material.color.copy(jT),l.material.emissive.set("#1d4ed8"),l.material.emissiveIntensity=.25;return}if(s.has(l.userData.locationId)){l.material.color.copy(ZT),l.material.emissive.set("#854d0e"),l.material.emissiveIntensity=.2;return}l.material.color.copy(l.userData.baseColor),l.material.emissive.set("#000000"),l.material.emissiveIntensity=0})}const JT={Boundary:"#8b949e","Layout Zone":"#c7d8ee","Main Aisle":"#40505a","Work Area":"#f2a65f",Pillar:"#374151",Gate:"#f59e0b",Wall:"#7b8794","Non-placeable Area":"#ef8b9a",Shelf:"#d6dadd",Nestainer:"#bfc9d6","Operation Area":"#ef4444",Shop:"#d6dadd",Path:"#3f484b",Dock:"#b7c7dd",Rack:"#c4cbd3",Office:"#ef4444"},i_=18,$T=.96,tA=.48,eA=12,a_=.7,s_=3.2;function nA({locations:r,hoveredLocationId:t,selectedLocationId:i,searchedLocationIds:s,onHoverLocation:l,onSelectLocation:c}){const h=ke.useRef(null),d=ke.useRef(new Map),m=ke.useRef(null),p=ke.useRef(null),[_,v]=ke.useState(1),[y,M]=ke.useState({x:0,y:0}),T=ke.useMemo(()=>new Set(s),[s]),A=(G,w,C=0)=>({x:(G-w)*i_*$T,y:(G+w)*i_*tA-C*eA}),S=r.map(G=>iA(G,A,T,i,t)).sort((G,w)=>G.depth-w.depth),x=rA(S.flatMap(G=>G.points)),L=r_(x,_,y),D=sA(r,A);return Kt.jsxs("svg",{"aria-label":"Warehouse 3D map",className:"isometric-map",onPointerCancel:z,onPointerDown:k,onPointerLeave:z,onPointerMove:N,onPointerUp:z,onWheel:F,ref:h,role:"img",viewBox:`${L.x} ${L.y} ${L.width} ${L.height}`,children:[Kt.jsx("defs",{children:Kt.jsx("filter",{id:"iso-shadow",x:"-20%",y:"-20%",width:"140%",height:"150%",children:Kt.jsx("feDropShadow",{dx:"0",dy:"8",floodColor:"#111827",floodOpacity:"0.25",stdDeviation:"5"})})}),Kt.jsx("rect",{className:"isometric-bg",x:L.x,y:L.y,width:L.width,height:L.height}),D&&Kt.jsx("polygon",{className:"isometric-floor",points:$o(D)}),S.map(G=>Kt.jsxs("g",{className:`iso-block ${G.isSelected?"selected":""} ${G.isSearched?"searched":""}`,onClick:()=>c(G.location.id),onMouseEnter:()=>l(G.location.id),onMouseLeave:()=>l(null),children:[Kt.jsx("polygon",{fill:G.rightColor,points:$o(G.rightFace)}),Kt.jsx("polygon",{fill:G.frontColor,points:$o(G.frontFace)}),Kt.jsx("polygon",{fill:G.topColor,points:$o(G.topFace)}),Kt.jsx("polyline",{className:"iso-block-outline",points:$o([...G.topFace,G.topFace[0]])}),G.showLabel&&Kt.jsx("text",{className:"iso-label",x:G.labelPoint.x,y:G.labelPoint.y,children:G.location.name})]},G.location.id))]});function F(G){G.preventDefault();const w=G.deltaY>0?-1:1,C=c_(_*(w>0?1.12:.88),a_,s_);v(C)}function k(G){const w=h.current;if(w){if(G.preventDefault(),w.setPointerCapture(G.pointerId),d.current.set(G.pointerId,{x:G.clientX,y:G.clientY}),d.current.size>=2){const[C,V]=[...d.current.values()];p.current={distance:o_(C,V),zoom:_},m.current=null;return}m.current={x:G.clientX,y:G.clientY,viewBox:L}}}function N(G){const w=h.current;if(!w||!d.current.has(G.pointerId))return;if(G.preventDefault(),d.current.set(G.pointerId,{x:G.clientX,y:G.clientY}),d.current.size>=2){const[ct,P]=[...d.current.values()],W=p.current;W&&v(c_(W.zoom*(o_(ct,P)/Math.max(W.distance,1)),a_,s_));return}const C=m.current;if(!C)return;const V=w.getBoundingClientRect(),et=(G.clientX-C.x)/Math.max(V.width,1)*C.viewBox.width,ot=(G.clientY-C.y)/Math.max(V.height,1)*C.viewBox.height,dt=r_(x,_,y);M(ct=>({x:ct.x-et,y:ct.y-ot})),m.current={...C,x:G.clientX,y:G.clientY,viewBox:dt}}function z(G){const w=h.current;if(w?.hasPointerCapture(G.pointerId)&&w.releasePointerCapture(G.pointerId),d.current.delete(G.pointerId),p.current=null,d.current.size===1){const[C]=d.current.values();m.current={x:C.x,y:C.y,viewBox:L};return}m.current=null}}function iA(r,t,i,s,l){const c=Math.max(r.zMax,r.zMin+.08),h=[t(r.xMin,r.yMin,c),t(r.xMax,r.yMin,c),t(r.xMax,r.yMax,c),t(r.xMin,r.yMax,c)],d=[t(r.xMin,r.yMax,r.zMin),t(r.xMax,r.yMax,r.zMin),t(r.xMax,r.yMax,c),t(r.xMin,r.yMax,c)],m=[t(r.xMax,r.yMin,r.zMin),t(r.xMax,r.yMax,r.zMin),t(r.xMax,r.yMax,c),t(r.xMax,r.yMin,c)],p=aA(r,i,s,l),_=t((r.xMin+r.xMax)/2,(r.yMin+r.yMax)/2,c+.45);return{location:r,topFace:h,frontFace:d,rightFace:m,points:[...h,...d,...m],labelPoint:_,topColor:p,frontColor:l_(p,-18),rightColor:l_(p,-28),depth:r.xMax+r.yMax+c,isSelected:r.id===s,isSearched:i.has(r.id),showLabel:r.type!=="Boundary"&&r.type!=="Path"}}function aA(r,t,i,s){return r.id===i?"#f97316":r.id===s?"#60a5fa":t.has(r.id)?"#facc15":JT[r.type]??"#d6dadd"}function sA(r,t){if(r.length===0)return null;const i=Math.min(...r.map(h=>h.xMin))-2,s=Math.min(...r.map(h=>h.yMin))-2,l=Math.max(...r.map(h=>h.xMax))+2,c=Math.max(...r.map(h=>h.yMax))+2;return[t(i,s,0),t(l,s,0),t(l,c,0),t(i,c,0)]}function rA(r){if(r.length===0)return{x:-400,y:-220,width:800,height:520};const t=Math.min(...r.map(h=>h.x)),i=Math.max(...r.map(h=>h.x)),s=Math.min(...r.map(h=>h.y)),l=Math.max(...r.map(h=>h.y)),c=110;return{x:t-c,y:s-c,width:i-t+c*2,height:l-s+c*2}}function r_(r,t,i){const s=r.width/t,l=r.height/t;return{x:r.x+(r.width-s)/2+i.x,y:r.y+(r.height-l)/2+i.y,width:s,height:l}}function $o(r){return r.map(t=>`${t.x},${t.y}`).join(" ")}function o_(r,t){return Math.hypot(r.x-t.x,r.y-t.y)}function l_(r,t){const i=r.replace("#",""),s=Number.parseInt(i.slice(0,2),16),l=Number.parseInt(i.slice(2,4),16),c=Number.parseInt(i.slice(4,6),16),h=d=>Math.min(255,Math.max(0,Math.round(d+d*t/100)));return`rgb(${h(s)}, ${h(l)}, ${h(c)})`}function c_(r,t,i){return Math.min(i,Math.max(t,r))}const oA={Boundary:"#d8dde2","Layout Zone":"#bfdbfe","Main Aisle":"#d9ebfb","Work Area":"#fed7aa",Pillar:"#334155",Gate:"#f59e0b",Wall:"#94a3b8","Non-placeable Area":"#fda4af",Shelf:"#0f766e",Nestainer:"#2563eb","Operation Area":"#fecaca",Shop:"#cfd4d9",Path:"#4b5258",Dock:"#2563eb",Rack:"#7c8a96",Office:"#ef4444"};function lA(r){const t=Math.max(r.xMax-r.xMin,.1),i=Math.max(r.yMax-r.yMin,.1),s=Math.max(r.zMax-r.zMin,.1),l=new qr(t,s,i),c=new ce(oA[r.type]),h=new G_({color:c,roughness:.55,metalness:.05,transparent:r.type==="Boundary",opacity:r.type==="Boundary"?.22:1}),d=new Li(l,h);return d.position.set(r.xMin+t/2,r.zMin+s/2,r.yMin+i/2),d.castShadow=r.type!=="Boundary",d.receiveShadow=!0,d.userData.locationId=r.id,d.userData.baseColor=c,d}function cA(r){const t=new tl;return r.forEach(i=>{const s=lA(i);t.add(s),i.type!=="Boundary"&&i.type!=="Main Aisle"&&t.add(uA(i))}),t}function uA(r){const t=document.createElement("canvas"),i=t.getContext("2d"),s=r.name||r.id,l=28,c=18,h=10;if(t.width=512,t.height=128,i){i.font=`700 ${l}px Inter, system-ui, sans-serif`;const M=Math.min(i.measureText(s).width,t.width-c*2),T=Math.ceil(M+c*2);i.fillStyle="rgba(255, 255, 255, 0.88)",i.strokeStyle="rgba(15, 23, 42, 0.22)",i.lineWidth=2,fA(i,0,0,T,l+h*2,8),i.fill(),i.stroke(),i.fillStyle="#17202a",i.textBaseline="middle",i.fillText(s,c,l/2+h,t.width-c*2)}const d=Math.max(r.xMax-r.xMin,.1),m=Math.max(r.yMax-r.yMin,.1),p=Math.max(r.zMax-r.zMin,.1),_=new BM(t),v=new z_({map:_,transparent:!0,depthTest:!1,depthWrite:!1}),y=new DM(v);return y.position.set(r.xMin+d/2,r.zMin+p+.28,r.yMin+m/2),y.scale.set(Math.min(Math.max(d,m,1.8),6),Math.min(Math.max(d,m,1.8),6)/4,1),y.renderOrder=10,y}function fA(r,t,i,s,l,c){r.beginPath(),r.moveTo(t+c,i),r.lineTo(t+s-c,i),r.quadraticCurveTo(t+s,i,t+s,i+c),r.lineTo(t+s,i+l-c),r.quadraticCurveTo(t+s,i+l,t+s-c,i+l),r.lineTo(t+c,i+l),r.quadraticCurveTo(t,i+l,t,i+l-c),r.lineTo(t,i+c),r.quadraticCurveTo(t,i,t+c,i),r.closePath()}function u_(r,t,i,s){const l=t.getBoundingClientRect(),c=new ne((r.clientX-l.left)/l.width*2-1,-((r.clientY-l.top)/l.height)*2+1),h=new kM;h.setFromCamera(c,i);const[d]=h.intersectObjects(s,!0),m=d?.object.userData.locationId;return typeof m=="string"?m:null}function hA({locations:r,hoveredLocationId:t,selectedLocationId:i,searchedLocationIds:s,onHoverLocation:l,onSelectLocation:c}){const h=ke.useRef(null),d=ke.useRef(null),m=ke.useRef(null),p=ke.useRef(null),_=ke.useRef(null),v=ke.useRef([]),[y,M]=ke.useState(null);return ke.useEffect(()=>{const T=h.current;if(!T)return;const A=T,S=new CM;S.background=new ce("#eef2f5"),S.fog=new ip("#eef2f5",90,180),d.current=S;let x;try{x=new NT({antialias:!0}),M(null)}catch{M("webgl-unavailable");return}x.setPixelRatio(Math.min(window.devicePixelRatio,2)),x.shadowMap.enabled=!0,x.shadowMap.type=m_,x.outputColorSpace=oi,A.appendChild(x.domElement);const L=new _i(45,1,.1,1e3);L.position.set(54,58,70),m.current=L;const D=new PT(L,x.domElement);D.enableDamping=!0,D.dampingFactor=.08,D.target.set(20,0,20),D.maxPolarAngle=Math.PI*.48,D.minDistance=18,D.maxDistance=145,p.current=D;const F=new HM("#ffffff","#a8b0b7",2.1);S.add(F);const k=new Rg("#ffffff",2.6);k.position.set(20,60,30),k.castShadow=!0,k.shadow.mapSize.set(2048,2048),k.shadow.camera.near=10,k.shadow.camera.far=140,S.add(k);const N=new Rg("#dbeafe",1.1);N.position.set(-40,34,-16),S.add(N);const z=new Li(new ol(80,80),new G_({color:"#f8fafc",roughness:.8}));z.rotation.x=-Math.PI/2,z.position.set(20,-.04,20),z.receiveShadow=!0,S.add(z);const G=new WM(80,40,"#94a3b8","#cbd5e1");G.position.set(20,.02,20),S.add(G);function w(){const{width:P,height:W}=A.getBoundingClientRect();x.setSize(P,W,!1),L.aspect=P/Math.max(W,1),L.updateProjectionMatrix()}const C=new ResizeObserver(w);C.observe(A),w();let V=0;function et(){D.update(),x.render(S,L),V=requestAnimationFrame(et)}et();const ot=P=>{const W=u_(P,x.domElement,L,v.current);l(W)},dt=()=>l(null),ct=P=>{const W=u_(P,x.domElement,L,v.current);W&&c(W)};return x.domElement.addEventListener("pointermove",ot),x.domElement.addEventListener("pointerleave",dt),x.domElement.addEventListener("pointerup",ct),()=>{cancelAnimationFrame(V),C.disconnect(),x.domElement.removeEventListener("pointermove",ot),x.domElement.removeEventListener("pointerleave",dt),x.domElement.removeEventListener("pointerup",ct),D.dispose(),x.dispose(),x.domElement.parentElement===A&&A.removeChild(x.domElement),p.current=null,d.current=null,m.current=null,_.current=null,v.current=[]}},[l,c]),ke.useEffect(()=>{const T=d.current;if(!T)return;_.current&&(T.remove(_.current),_.current.traverse(D=>{pA(D)}));const A=cA(r),S=[];A.traverse(D=>{D instanceof Li&&S.push(D)}),_.current=A,v.current=S,T.add(A);const x=m.current,L=p.current;x&&L&&r.length>0&&dA(x,L,A)},[r]),ke.useEffect(()=>{QT(v.current,t,i,new Set(s))},[t,i,s,r]),ke.useEffect(()=>{const T=m.current,A=p.current;if(!T||!A||!i)return;const S=v.current.find(L=>L.userData.locationId===i);if(!S)return;const x=new tt;S.getWorldPosition(x),A.target.lerp(x,.55),A.update()},[i]),Kt.jsx("div",{className:"three-map-canvas",ref:h,children:y&&Kt.jsx(nA,{locations:r,hoveredLocationId:t,selectedLocationId:i,searchedLocationIds:s,onHoverLocation:l,onSelectLocation:c})})}function dA(r,t,i){const s=new Yr().setFromObject(i),l=s.getCenter(new tt),c=s.getSize(new tt),d=Math.max(c.x,c.y,c.z,1)*1.65;t.target.copy(l),r.position.set(l.x+d*.72,l.y+d*.88,l.z+d),r.near=Math.max(d/120,.1),r.far=d*8,r.updateProjectionMatrix(),t.update()}function pA(r){const t=r,i=t.geometry,s=t.material;i?.dispose(),Array.isArray(s)?s.forEach(f_):f_(s)}function f_(r){if(!r)return;r.map?.dispose(),r.dispose()}function mA({locations:r,hoveredLocationId:t,selectedLocationId:i,searchedLocationIds:s,onHoverLocation:l,onSelectLocation:c}){return Kt.jsxs("section",{className:"map-container",children:[Kt.jsx(hA,{locations:r,hoveredLocationId:t,selectedLocationId:i,searchedLocationIds:s,onHoverLocation:l,onSelectLocation:c}),Kt.jsx("p",{className:"map-hint",children:"Pinch or scroll to zoom and drag to move"})]})}async function xA(){const r=await fetch("/api/locations");if(!r.ok)throw new Error(`Failed to load locations: ${r.status}`);return r.json()}const gA="/data/location.csv",_A=new Set(["Boundary","Layout Zone","Main Aisle","Work Area","Pillar","Gate","Wall","Non-placeable Area","Shelf","Nestainer","Operation Area","Shop","Path","Dock","Rack","Office"]);async function vA(r=gA){const t=await fetch(r,{cache:"no-store"});if(!t.ok)throw new Error(`Failed to load CSV: ${t.status}`);return yA(await t.text())}function yA(r){const t=SA(r).filter(s=>s.some(l=>l.trim()!==""));if(t.length<2)return[];const i=t[0].map(s=>s.trim());return t.slice(1).map(s=>MA(i,s)).map(bA).filter(s=>s!==null)}function SA(r){const t=[];let i=[],s="",l=!1;for(let c=0;c<r.length;c+=1){const h=r[c],d=r[c+1];if(h==='"'&&l&&d==='"'){s+='"',c+=1;continue}if(h==='"'){l=!l;continue}if(h===","&&!l){i.push(s),s="";continue}if((h===`
`||h==="\r")&&!l){h==="\r"&&d===`
`&&(c+=1),i.push(s),t.push(i),i=[],s="";continue}s+=h}return(s||i.length>0)&&(i.push(s),t.push(i)),t}function MA(r,t){return Object.fromEntries(r.map((i,s)=>[i,t[s]??""]))}function bA(r){const t=EA(r.type),i=r.id.trim();return!i||!t?null:{id:i,type:t,name:r.name.trim()||i,xMin:Or(r.xMin),yMin:Or(r.yMin),xMax:Or(r.xMax),yMax:Or(r.yMax),zMin:Or(r.zMin),zMax:Or(r.zMax),description:r.description.trim()||void 0}}function EA(r){const t=r.trim();return _A.has(t)?t:null}function Or(r){const t=Number.parseFloat(r);return Number.isFinite(t)?t:0}const TA="/data/20260501_VisualizationInput_v7.xlsx",jn=1/1e3,zr=.2,h_={boundary:"Boundary",gate:"Gate","layout area":"Layout Zone","main aisle":"Main Aisle","main asile":"Main Aisle","non-placeable area":"Non-placeable Area","non placeable area":"Non-placeable Area","nonplaceable area":"Non-placeable Area",pillar:"Pillar",wall:"Wall","work area":"Work Area"};async function AA(r=TA){if(!window.XLSX)throw new Error("Excel parser is not loaded");const t=await fetch(r,{cache:"no-store"});if(!t.ok)throw new Error(`Failed to load workbook: ${t.status}`);const i=window.XLSX.read(await t.arrayBuffer(),{type:"array"}),s=Object.fromEntries(i.SheetNames.map(l=>[l,RA(i,l)]));return wA({facilityRows:s.Facility??[],materialHandlingRows:s.MaterialHandling??[],planRows:s.Plan??[],patternRows:s.PatternResult??[]})}function RA(r,t){const i=r.Sheets[t];return!i||!window.XLSX?[]:window.XLSX.utils.sheet_to_json(i,{defval:"",raw:!1,blankrows:!1}).filter(s=>Object.values(s).some(l=>String(l??"").trim()!=="")).map(CA)}function CA(r){const t={};return Object.entries(r).forEach(([i,s])=>{t[i.toLowerCase().replace(/\s+/g,"")]=s}),t}function wA({facilityRows:r,materialHandlingRows:t,planRows:i,patternRows:s}){const l=r.map(DA).filter(y=>y!==null);if(l.length===0)return[];const c={x:Math.min(...l.map(y=>y.absoluteX)),y:Math.min(...l.map(y=>y.absoluteY))},h=NA(i,s),d=h?s.filter(y=>Si(y.planid)===h):s,m=new Map(t.map(y=>[Si(y.materialhandlingcode).toLowerCase(),y])),p=OA(d),_=l.map(y=>LA(y,c)),v=d.map(y=>UA(y,m,c,p)).filter(y=>y!==null);return[..._,...v]}function DA(r){const t=PA(r.facilitytype);if(!t)return null;const i=zn(r.x0??r.locationx),s=zn(r.y0??r.locationy),l=zn(r.z0??r.locationz),c=r.x1==null||r.x1===""?i+zn(r.width):zn(r.x1),h=r.y1==null||r.y1===""?s+zn(r.depth):zn(r.y1),d=r.z1==null||r.z1===""?l+zn(r.height):zn(r.z1),m=Si(r.facilitycode),p=Si(r.facilityname)||m||t;return{id:`facility-${m||p}`,name:p,type:t,absoluteX:Math.min(i,c),absoluteY:Math.min(s,h),baseZ:Math.min(l,d)*jn,width:Math.max(Math.abs(c-i)*jn,zr),depth:Math.max(Math.abs(h-s)*jn,zr),height:Math.max(Math.abs(d-l)*jn,FA(t)),description:`${t} from Facility sheet${m?` (${m})`:""}.`}}function UA(r,t,i,s){const l=Si(r.materialhandlingcode),c=t.get(l.toLowerCase()),h=zA(l,c),[d,m]=d_(zn(r.x0),zn(r.x1)),[p,_]=d_(zn(r.y0),zn(r.y1)),v=zn(c?.width)*jn,y=zn(c?.depth)*jn,M=Math.max((m-d)*s,v,zr),T=Math.max((_-p)*s,y,zr),A=Si(r.patternresultid),x=Si(c?.materialhandlingname)||l||A||h,L=zn(c?.height)*jn||BA(h);return!A&&!l&&M<=zr&&T<=zr?null:{id:`pattern-${A||l}-${d}-${p}`,name:x,type:h,xMin:d*s-i.x*jn,yMin:p*s-i.y*jn,xMax:d*s-i.x*jn+M,yMax:p*s-i.y*jn+T,zMin:0,zMax:L,description:`${h} from PatternResult${A?` (${A})`:""}.`}}function LA(r,t){const i=(r.absoluteX-t.x)*jn,s=(r.absoluteY-t.y)*jn;return{id:r.id,name:r.name,type:r.type,xMin:i,yMin:s,xMax:i+r.width,yMax:s+r.depth,zMin:r.baseZ,zMax:r.baseZ+r.height,description:r.description}}function NA(r,t){const i=Si(r[0]?.planid);return i||Si(t[0]?.planid)}function OA(r){return r.some(t=>"materialhandlingcode"in t)?jn:1}function PA(r){const t=Si(r).toLowerCase().replace(/[_\s]+/g," "),i=h_[t];return i||(Object.entries(h_).find(([l])=>t.startsWith(l))?.[1]??null)}function zA(r,t){const i=Si(t?.storedunittype).toLowerCase(),s=Si(t?.materialhandlingname).toLowerCase(),l=`${r} ${s}`.toLowerCase();return l.includes("operation_area")?"Operation Area":i.includes("pallet")||l.includes("nestainer")||l.includes("rack")?"Nestainer":"Shelf"}function BA(r){return r==="Nestainer"?1.35:r==="Operation Area"?.05:1.8}function FA(r){return r==="Pillar"?4:r==="Gate"?3.5:r==="Wall"?2.8:r==="Boundary"?.12:.03}function d_(r,t){return r<=t?[r,t]:[t,r]}function Si(r){return r==null?"":String(r).trim()}function zn(r){const t=Number.parseFloat(String(r??""));return Number.isFinite(t)?t:0}function IA(){const[r,t]=ke.useState([]),[i,s]=ke.useState(!0),[l,c]=ke.useState(null);return ke.useEffect(()=>{let h=!1;async function d(){try{s(!0),c(null);let m;try{m=await vA()}catch{try{m=await AA()}catch{m=await xA()}}h||t(m)}catch(m){h||c(m instanceof Error?m.message:"Failed to load locations")}finally{h||s(!1)}}return d(),()=>{h=!0}},[]),{locations:r,loading:i,error:l}}function HA(r){const[t,i]=ke.useState(null),[s,l]=ke.useState(null);return{selectedLocation:ke.useMemo(()=>r.find(h=>h.id===t)??null,[r,t]),selectedLocationId:t,hoveredLocationId:s,setSelectedLocationId:i,setHoveredLocationId:l}}function GA(){const{locations:r,loading:t,error:i}=IA(),s=HA(r),[l,c]=ke.useState(""),h=ke.useMemo(()=>{const m=l.trim().toLowerCase();return m?r.filter(p=>p.name.toLowerCase().includes(m)||p.type.toLowerCase().includes(m)||p.description?.toLowerCase().includes(m)):r},[r,l]),d=l.trim()?h.map(m=>m.id):[];return Kt.jsxs("div",{className:"app-shell",children:[Kt.jsx(dS,{query:l,locations:h,selectedLocation:s.selectedLocation,selectedLocationId:s.selectedLocationId,onQueryChange:c,onSelectLocation:s.setSelectedLocationId}),Kt.jsxs("main",{className:"main-panel",children:[Kt.jsx(mA,{locations:r,selectedLocationId:s.selectedLocationId,hoveredLocationId:s.hoveredLocationId,searchedLocationIds:d,onHoverLocation:s.setHoveredLocationId,onSelectLocation:s.setSelectedLocationId}),t&&Kt.jsx("div",{className:"map-status",children:"Loading layout..."}),i&&Kt.jsx("div",{className:"map-status map-status-error",children:i}),Kt.jsx(fS,{})]})]})}cS.createRoot(document.getElementById("root")).render(Kt.jsx(ke.StrictMode,{children:Kt.jsx(GA,{})}));
